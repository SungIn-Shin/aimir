...
public interface PrepaymentChargeManager {
     ...
     * @return
     */
    public Integer getAbnormalDeductionListTotalCount(Map<String, Object> conditionMap) throws Exception;
    
    /**
     * method name : abnormalDeductionDetailView<b/>
     * method Desc : Abnormal Deduction Customer List의 DetailView 를 조회한다.
     *
     * @param conditionMap
     * @return
     */
