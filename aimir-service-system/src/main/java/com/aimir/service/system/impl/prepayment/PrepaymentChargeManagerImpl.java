...
public class PrepaymentChargeManagerImpl implements PrepaymentChargeManager {
    ...
    public List<Map<String, Object>> getChargeHistoryList(Map<String, Object> conditionMap) {
        ...
        for (Map<String, Object> map : result) {
        	String chargedCredit = (map.get("chargedCredit") != null) ? cdf.format(DecimalUtil.ConvertNumberToDouble(map.get("chargedCredit"))) : cdf.format(0d);
        	
        	//Long타입 ID를 String으로 변환...(변환하지 않으면, jsp로 넘어갈때 반올림되어버린다)
        	Long logId = (map.get("prepaymentLogId") != null) ? (Long)map.get("prepaymentLogId") : 0l;
        	map.put("prepaymentLogId", logId.toString());
...
//            map.put("chargedCredit", ((map.get("chargedCredit") != null) ? cdf.format(DecimalUtil.ConvertNumberToDouble(map.get("chargedCredit"))) : cdf.format(0d)));
            map.put("chargedCredit", chargedCredit);
            map.put("cancelCredit", ((map.get("isCanceled") != null) ? chargedCredit : cdf.format(0d)));
        }
    ...
    /**
     * @overrideMethod  : balanceAdjustmentSPASA
     * @date	: 2018. 5. 16.
     * 본 기능은 추후 병합 예정.
     */
    public Map<String, Object> balanceTransferSPASA(Map<String, Object> conditionMap){
    	return null;
    }
     ...
     * 본 기능은 추후 병합 예정.
     */
    public Map<String, Object> balanceAdjustmentSPASA(Map<String, Object> conditionMap) {
    	return null;
    }
...
//    		returnValue = String.valueOf(cdf.format(Math.abs(valueD)));
	...
	public String cancelTransaction(Long id, String operatorId, String reason) {
		...
		try {
			...
			if(!isCancelled) {
				...
				if ( commitedVendor.getRole().getName().contains("vendor")) {
	...
	/**
     * method name : getAbnormalDeductionList<b/>
     ...
     */
    @Override
    public List<Map<String, Object>> getAbnormalDeductionList(Map<String, Object> conditionMap) throws Exception {
        Integer supplierId = (Integer)conditionMap.get("supplierId");
        List<Map<String, Object>> result = contractDao.getAbnormalDeductionList(conditionMap, false);
    ...
    /**
     * method name : getAbnormalDeductionListTotalCount<b/>
     * method Desc : Prepayment Customer Management 가젯에서 Abnormal Deduction Customer List 의 Total Count 를 조회한다.
     *
     * @param conditionMap
     * @return
     */
    @Override
    public Integer getAbnormalDeductionListTotalCount(Map<String, Object> conditionMap) {
        List<Map<String, Object>> result = contractDao.getAbnormalDeductionList(conditionMap, true);
        return (Integer)(result.get(0).get("total"));
    }
    
    /**
     * method name : abnormalDeductionDetailView<b/>
     * method Desc : Abnormal Deduction Customer List 에서 선택된 그리드내 contractId에 해당하는 DetailView Popup을 조회한다.
     *
      * @param conditionMap
     * @return
     */
    public List<Map<String, Object>> deductionDetailView(Map<String, Object> conditionMap) throws Exception{
    	Integer supplierId = (Integer)conditionMap.get("supplierId");
    	List<Map<String, Object>> result = contractDao.deductionDetailView(conditionMap, false);
    	Supplier supplier = supplierDao.get(supplierId);
        String lang = supplier.getLang().getCode_2letter();
        String country = supplier.getCountry().getCode_2letter();

        for (Map<String, Object> map : result) {
        	map.put("hiddenWriteDate", map.get("WRITEDATE"));
            map.put("WRITEDATE", TimeLocaleUtil.getLocaleDate((String)map.get("WRITEDATE"), lang, country));
            map.put("HHMMSS", TimeLocaleUtil.getLocaleDate((String)map.get("HHMMSS"), lang, country));
            map.put("YYYYMMDD", TimeLocaleUtil.getLocaleDate((String)map.get("YYYYMMDD"), lang, country));
        }
    	return result;
    }
    public List<Map<String, Object>> prepaymentLogDetailView(Map<String, Object> conditionMap) throws Exception{
    	Integer supplierId = (Integer)conditionMap.get("supplierId");
    	List<Map<String, Object>> result = contractDao.prepaymentLogDetailView(conditionMap, false);
    	Supplier supplier = supplierDao.get(supplierId);
        String lang = supplier.getLang().getCode_2letter();
        String country = supplier.getCountry().getCode_2letter();
    ...
    public List<Map<String, Object>> trackCustomerChargeDetailView(Map<String, Object> conditionMap) throws Exception{
    	Integer supplierId = (Integer)conditionMap.get("supplierId");
    	List<Map<String, Object>> result = contractDao.trackCustomerChargeDetailView(conditionMap, false);
    	Supplier supplier = supplierDao.get(supplierId);
        String lang = supplier.getLang().getCode_2letter();
        String country = supplier.getCountry().getCode_2letter();
    ...
    public List<Map<String, Object>> loadProfileDetailView(Map<String, Object> conditionMap) throws Exception{
    	Integer supplierId = (Integer)conditionMap.get("supplierId");
    	List<Map<String, Object>> result = contractDao.loadProfileDetailView(conditionMap, false);
    	Supplier supplier = supplierDao.get(supplierId);
        String lang = supplier.getLang().getCode_2letter();
        String country = supplier.getCountry().getCode_2letter();
    ...
    /**
     * method name : getAbnormalDeductionListTotalCount<b/>
     * method Desc : Abnormal Deduction Customer List의 DetailView 의 Total Count 를 조회한다.
     *
     * @param conditionMap
     * @return
     */
    public Integer deductionDetailListTotalCount(Map<String, Object> conditionMap) throws Exception{
    	List<Map<String, Object>> result = contractDao.deductionDetailView(conditionMap, true);
        return (Integer)(result.get(0).get("total"));
    }
    public Integer prepaymentLogDetailListTotalCount(Map<String, Object> conditionMap) throws Exception{
    	List<Map<String, Object>> result = contractDao.prepaymentLogDetailView(conditionMap, true);
        return (Integer)(result.get(0).get("total"));
    }
    public Integer trackCustomerChargeDetailListTotalCount(Map<String, Object> conditionMap) throws Exception{
    	List<Map<String, Object>> result = contractDao.trackCustomerChargeDetailView(conditionMap, true);
        return (Integer)(result.get(0).get("total"));
    }
    public Integer loadProfileDetailListTotalCount(Map<String, Object> conditionMap) throws Exception{
    	List<Map<String, Object>> result = contractDao.loadProfileDetailView(conditionMap, true);
        return (Integer)(result.get(0).get("total"));
    }
    
    @Transactional(value = "transactionManager", rollbackFor = {Exception.class,DataAccessException.class})
    public String deleteDeduction(String[] contractArr, String[] writedateArr) {
    	String result = "failed";
    	try {
    		for (int i = 0; i < contractArr.length; i++) {
    			contractDao.recoverDeduction(contractArr[i], writedateArr[i]);
    			contractDao.deleteDeduction(contractArr[i], writedateArr[i]);
    		}
   			result = "success";
		} catch (Exception e) {
			result = "Can't delete deduction";
		}
    	return result;
    }
    
    public List<Map<String, Object>> getRecoveryHistoryList(Map<String, Object> conditionMap) throws Exception{
    	Integer supplierId = (Integer)conditionMap.get("supplierId");
    	List<Map<String, Object>> result = contractDao.getRecoveryHistoryList(conditionMap, false);
    	Supplier supplier = supplierDao.get(supplierId);
        String lang = supplier.getLang().getCode_2letter();
        String country = supplier.getCountry().getCode_2letter();
    ...
    public Integer getRecoveryHistoryListTotalCount(Map<String, Object> conditionMap) throws Exception {
    	List<Map<String, Object>> result = contractDao.getRecoveryHistoryList(conditionMap, true);
    	return (Integer)(result.get(0).get("total"));
    	
    }
    
    @Transactional(value = "transactionManager", rollbackFor = {Exception.class,DataAccessException.class})
    public String recoveryHistoryUndo(Map<String, Object> conditionMap) throws Exception{
    	String result = "failed";
		try {
   			contractDao.recoveryHistoryUndo(conditionMap);
   			contractDao.recoveryHistoryUpdate(conditionMap);
   			result = "success";
		} catch (Exception e) {
			result = "Can't undo recoveryHistory";
		}
    	return result;
    }
