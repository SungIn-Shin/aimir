...
public class GeneralFrame {
	...
	public enum NIAttributeId {
		...
		// INSERT NGM-54
        CircuitBreaker(new byte[] { (byte) 0x30, (byte) 0x05 }),
        CircuitBreaker_GET(new byte[] { (byte) 0x30, (byte) 0x05 }),
		BypassMeterInterface(new byte[] { (byte) 0x00, (byte) 0x0C }),
		BypassMeterInterface_GET(new byte[] { (byte) 0x00, (byte) 0x0C });
		// INSERT END NGM-54		
		private byte[] code;
