...
import com.aimir.fep.trap.actions.EV_SP_200_63_0_Action;
	...
	public Object executeTransaction(MultiSession session, GeneralFrame gFrame) throws Exception {
		...
		try {
			...
			case UpgradeImageInstallResponse:
				...
				action2.makeEvent(TargetClass.valueOf(bd.getModemType().name()), bd.getModemId(), bd.getTargetClass(), openTime, OTA_UPGRADE_RESULT_CODE.OTAERR_NOERROR, msg, "HES");
				action2.updateOTAHistory(bd.getOtaTargetDeviceType() == DeviceType.Modem ? bd.getModemId() : bd.getMeterId(), bd.getOtaTargetDeviceType(), openTime, OTA_UPGRADE_RESULT_CODE.OTAERR_NOERROR, msg);
