    ...
    public String createResponseStr(String attrID, String requestType){
        ...
        case CircuitBreaker:
        	if(requestType.equals("SET")){
        		...
        		//Set Resutl(0: Success, 1: Fail)
        		if(bx[0] == 0x01) {
        			Response = "CBControl-Fail";
        		}else if(bx[0] == 0x00) {
        			Response = "CBControl-Success";
        		}else {
        			Response = "Unknown Status=["+Hex.decode(bx)+"]";
        		}
        	} else if(requestType.equals("GET")){

        		//	CB Status(1: ON, 0: OFF)
        		if(bx[0] == 0x01) {
        			Response = "CBStatus-ON";
        		}else if(bx[0] == 0x00) {
        			Response = "CBStatus-OFF";
        		}else {
        			Response = "Unknown Status=["+Hex.decode(bx)+"]";
        		}
        	} 
        ...
        case BypassMeterInterface:
        	if(requestType.equals("GET") || requestType.equals("SET")){
        		...
        		buffer.append(bx[0] == 0x01 ? "Default Meter Interface, " : "Etc Meter Interface, ");
        		buffer.append(bx[1] == 0x00 ? "Can be Bypass Interface chang " : "Can not Meter Interface Not chang ");
