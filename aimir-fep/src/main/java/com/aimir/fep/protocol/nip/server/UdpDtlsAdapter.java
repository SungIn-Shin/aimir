...
public class UdpDtlsAdapter implements UdpDtlsAdapterMBean, MBeanRegistration {
    ...
    public void start() throws Exception{
        ...
        dtlsHandler = DataUtil.getBean(NiDtlsProtocolHandler.class);// new NiDtlsProtocolHandler(false, dtlsConnector, null, this.getClass().getSimpleName() + ":" + DateTimeUtil.getCurrentDateTimeByFormat(null));
        dtlsHandler.setIsCmdAdapter(false);
        dtlsHandler.setDtlsConnector(dtlsConnector);
        dtlsHandler.setHandlerName(this.getClass().getSimpleName() + ":" + DateTimeUtil.getCurrentDateTimeByFormat(null));
        ...
        dtlsConnector.setErrorHandler(new ErrorHandler(){
            ...
            public void onError(InetSocketAddress peerAddress, AlertLevel level,
                ...
                DataUtil.getBean(EventUtil.class).sendEvent("Security Alarm",
