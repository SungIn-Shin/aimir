...
public class SORIAMeterOTACallable implements IBatchCallable {
	...
	public Map<CBE_RESULT_CONSTANTS, Object> call() throws Exception {
		...
		if (!excuteResult) {
			...
			action2.makeEvent(TargetClass.EnergyMeter, target.getMeterId(), TargetClass.EnergyMeter, openTime, "0", OTA_UPGRADE_RESULT_CODE.OTAERR_BYPASS_EXCUTE_FAIL, null, "HES");
			...
			action3.makeEvent(TargetClass.EnergyMeter, target.getMeterId(), TargetClass.EnergyMeter, openTime, OTA_UPGRADE_RESULT_CODE.OTAERR_BYPASS_EXCUTE_FAIL, null, "HES");
