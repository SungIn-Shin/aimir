 ...
 */
@Service
public class EV_TW_240_1_0_Action implements EV_Action
{
    private static Log log = LogFactory.getLog(EV_TW_240_1_0_Action.class);
    ...
    public void execute(FMPTrap trap, EventAlertLog event) throws Exception
    {
        ...
        try {
        	if ("NAMR-P20CSR".equals(nodeKind) || "NAMR-P20DSR".equals(nodeKind)){ 
		        ...
		        if (modem == null) {
		            ...
		            */
		            ...
		            List<DeviceModel> models = deviceModelDao.getDeviceModelByName(mcu.getSupplierId(), nodeKind);//SP-862
        	...
        	}else if ("NCB-S202".equals(nodeKind)){
        		// SP-766 (NCB-S201)
                try{
