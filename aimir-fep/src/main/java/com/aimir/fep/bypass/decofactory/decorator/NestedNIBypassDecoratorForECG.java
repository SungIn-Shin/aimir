 ...
 *
 */
public class NestedNIBypassDecoratorForECG extends NestFrameDecorator {
	private static Logger logger = LoggerFactory.getLogger(NestedNIBypassDecoratorForECG.class);
	private byte[] gdNIFrame = null;
	private Target  target = null;
	private NetworkType networkType = NetworkType.Ethernet;
	 ...
	 * @param nestedFrame
	 */
	public NestedNIBypassDecoratorForECG(INestedFrame nestedFrame) {
		super(nestedFrame);
	}
	...
	public boolean decode(byte[] frame, Procedure procedure, String command) {
		...
		logger.info("## Excute NestedNIBypassDecoratorForECG Decoding...");
	...
	public byte[] encode(HdlcObjectType hdlcType, Procedure procedure, HashMap<String, Object> param, String command) {
		// TODO Auto-generated method stub
		logger.info("## Excute NestedNIBypassDecoratorForECG Encoding [{}]", hdlcType.name());
//		logger.info("## Excute NestedNIBypassDecoratorForECG Encoding params = [{}]", param.toString());
		logger.info("## Excute NestedNIBypassDecoratorForECG Encoding params = [{}]", param == null ? "null" : param.toString());
	...
	public boolean isHdlcRRFrame() {
		...
		if ( nestedFrame != null && nestedFrame instanceof NestedHDLCDecoratorForECG ){
			NestedHDLCDecoratorForECG hdlcFrame = (NestedHDLCDecoratorForECG)nestedFrame;
