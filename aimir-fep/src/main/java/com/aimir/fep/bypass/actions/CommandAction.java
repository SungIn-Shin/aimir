...
public abstract class CommandAction {
     ...
     * @throws Exception
     */
    public abstract void execute(String cmd, int errorCode, IoSession session) throws Exception;
    ...
    /**
     * ECG에서  Bypass를 통해 결과를 받아오기 위한 것이다. (Zigbee STS)
     * @param frame
     * @param session
     * @throws Exception
     */
	public abstract void executeBypass2 (byte[] frame, IoSession session) throws Exception;
}
