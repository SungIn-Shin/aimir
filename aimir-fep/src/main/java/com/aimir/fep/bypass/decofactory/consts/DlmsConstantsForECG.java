...
public class DlmsConstantsForECG {
	private static Logger logger = LoggerFactory.getLogger(DlmsConstantsForECG.class);
	...
	public enum DlmsPiece {
		  ...
		  CLIENT_SYSTEM_TITLE("5753453030303031")	  // Client System Title : NTC00001	 // Ghana TVWS
	...
	public enum AARQ_LLS {
		 PROTOCOL_VERSION(0, "")
			...
			, CALLING_AUTHENTICATION_VALUE(12, "AC0A8008") //   -- CtoS(challenge)
			, IMPLEMENTATION_INFORMATION(29, "")
			//, USER_INFORMATION(30, "BE10040E01000000065F1F0400007E1F0000")
			, USER_INFORMATION(30, "BE10040E01000000065F1F0400007E1F0000")
			, APPLICATION(97, "60")
			...
			private AARQ_LLS(int code, String value) {
				this.code = code;
				this.value = value;
			}
			...
			public static AARQ_LLS getItem(int code) {
				for (AARQ_LLS fc : AARQ_LLS.values()) {
					if (fc.code == code) {
						return fc;
					}
				}
	...
	*/
	...
	/*
	 * ECG Meter RelayStatus Attributes
	 * - class_id = 70 (0046) 
	 ...
	 * Friendly Set/Get
	 * - class_id = 1 (0001) 
	 * - OBIS CODE = 0.0.96.50.52.255 (0000603234FF)
	 * 
	 * @author hanseungwoo
	 *
	 */
	public enum FriendlyTimeAttributes {
		CLASS_ID("0001"), OBIS_CODE("0000603234FF"), FRIENDLY_TIME("02"), OPTION_NOT_USE("00");
		
		private String code;

		private FriendlyTimeAttributes(String code) {
			this.code = code;
		}
		...
		public static FriendlyTimeAttributes getItem(String code) {
			for (FriendlyTimeAttributes fc : FriendlyTimeAttributes.values()) {
				if (fc.code.equals(code)) {
					return fc;
				}
			}
	 ...
	 * Friendly Set/Get
	 * - class_id = 1 (0001) 
	 * - OBIS CODE = 0.0.96.50.53.255 (0000603235FF)
	 * 
	 * @author hanseungwoo
	 *
	 */
	public enum FriendlyWeekAttributes {
		CLASS_ID("0001"), OBIS_CODE("0000603235FF"), FRIENDLY_TIME("02"), OPTION_NOT_USE("00");
		
		private String code;

		private FriendlyWeekAttributes(String code) {
			this.code = code;
		}
		...
		public static FriendlyWeekAttributes getItem(String code) {
			for (FriendlyWeekAttributes fc : FriendlyWeekAttributes.values()) {
				if (fc.code.equals(code)) {
					return fc;
				}
			}
	...
	/*
	 * Credit charge Event Log Set/Get
	 * - class_id = 1 (0001) 
	 * - OBIS CODE = 0.0.96.50.53.255 (0000603235FF)
	 * 
	 * @author hanseungwoo
	...
	public enum TokenCreditEventAttributes {
		CLASS_ID("0007"), OBIS_CODE("0100630F00FF"), Attribute("02"), OPTION_NOT_USE("00"), OPTION_USE("01");
		
		private String code;

		private TokenCreditEventAttributes(String code) {
			this.code = code;
		}
		...
		public static TokenCreditEventAttributes getItem(String code) {
			for (TokenCreditEventAttributes fc : TokenCreditEventAttributes.values()) {
				if (fc.code.equals(code)) {
					return fc;
				}
			}
