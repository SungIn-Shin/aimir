...
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.AARE;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.AARQ;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.ASSOCIATION_LN;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.ActionRequest;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.ActionResponse;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.ActionResult;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.DLMSCommonDataType;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.DataAccessResult;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.DemandPeriodAttributes;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.DlmsPiece;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.GetDataResult;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.GetRequest;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.GetResponse;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.ImageTransfer;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.ImageTransferAttributes;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.ImageTransferMethods;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.MeterBillingCycleAttributes;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.MeterFWInfoAttributes;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.MeterParamSetMethods;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.SetRequest;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.SetResponse;
import com.aimir.fep.bypass.decofactory.consts.DlmsConstantsForMOE.TOUAttributes;
...
import com.aimir.fep.bypass.decofactory.consts.HLSAuthForMOE.HLSSecurity;
...
public class NestedDLMSDecoratorForMOE extends NestFrameDecorator {
	private static Logger logger = LoggerFactory.getLogger(NestedDLMSDecoratorForMOE.class);
		...
		try {
			...
			case ACTION_REQ:
				...
				case HDLC_ASSOCIATION_LN:
					...
					HLSAuthForMOE auth = new HLSAuthForMOE(HLSSecurity.AUTHENTICATION);
					...
					case NORMAL:
						...
						if (aResult == GetDataResult.DATA) {
							...
							case Boolean:
								...
								System.arraycopy(information, infoPos, data, 0, data.length);
								infoPos += data.length;
								boolean getResult = Boolean.valueOf(String.valueOf(DlmsConstantsForMOE.getValueByDLMSCommonDataType(DLMSCommonDataType.Boolean, data)));
							...
							case UINT32:
								...
								System.arraycopy(information, infoPos, data, 0, data.length);
								infoPos += data.length;
								long longResult = Long.parseLong(String.valueOf(DlmsConstantsForMOE.getValueByDLMSCommonDataType(DLMSCommonDataType.UINT32, data)));
							...
							case Array:
								...
								if (procedure == Procedure.GET_IMAGE_TO_ACTIVATE_INFO) {
									...
									long image_to_activate_size = Long.parseLong(String.valueOf(DlmsConstantsForMOE.getValueByDLMSCommonDataType(DLMSCommonDataType.UINT32, image_to_activate_sizeData)));
