...
public abstract class BypassFrameFactory {
	...
	public enum Procedure {
		...
		,GET_STS_SWITCH_TIME
		/*
		 * Get STS Register Value
		 */
		,GET_STS_REGISTER_VALUE
		/*
		 * Set STS Register Value
		 */
		,SET_STS_REGISTER_VALUE
		/*
		 * Set STS Days Table Value
		 */
	 ...
	 * @throws Exception
	 */
	//public abstract Object receiveBypass(IoSession session, byte[] rawFrame) throws Exception;
	
	public abstract BypassFrameResult receiveBypass(MultiSession session, byte[] rawFrame) throws Exception;
	public abstract BypassFrameResult receiveBypass2(IoSession session, byte[] rawFrame) throws Exception;

	public abstract boolean start(MultiSession session, Object type) throws Exception;
	public abstract boolean start2(IoSession session, Object type) throws Exception;

	public abstract void setParam(HashMap<String, Object> params);

	public abstract void stop(MultiSession session);
	public abstract void stop2(IoSession session);
