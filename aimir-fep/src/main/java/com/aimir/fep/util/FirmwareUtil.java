...
{
	private static Logger log = LoggerFactory.getLogger(FirmwareUtil.class);
	...
	public void updateTriggerAndHistory(String triggerId, int equipType, String equipId, int jobState, int jobErrorCode){
		try{
	 ...
	 */
	@Transactional(propagation=Propagation.REQUIRES_NEW)
	public void updateTriggerHistory(String triggerId, int triggerStep, int triggerState){
	...
	public void updateOTAHistory(String deviceId, DeviceType deviceType, String openTime, 
	        String requestId, String EVENT_MESSAGE) {
        ...
        try {
            if (requestId != null) {
                fwIssueHistoryDao.updateOTAHistory(EVENT_MESSAGE, deviceId, deviceType, openTime, "OK", requestId);
            } else {
                fwIssueHistoryDao.updateOTAHistory(EVENT_MESSAGE, deviceId, deviceType, openTime, "OK");
            }
        ...
        try {
            if (requestId != null) {
                fwIssueHistoryDao.updateOTAHistoryIssue(EVENT_MESSAGE, deviceId, deviceType, requestId);
            } else {
                fwIssueHistoryDao.updateOTAHistoryIssue(EVENT_MESSAGE, deviceId, deviceType);
            }
	...
	@Transactional(propagation=Propagation.REQUIRES_NEW)
	public void updateOTAHistory(String deviceId, DeviceType deviceType, String openTime, 
	        OTA_UPGRADE_RESULT_CODE resultCode, String desc, String requestId, String EVENT_MESSAGE) {
        log.debug("updateOTAHistory save start.");
        log.debug("Update OTA History params. DeviceId={}, DeviceType={}, OpentTime={}, ResultCode={}, Desc={}", deviceId, deviceType.name(), openTime, resultCode, desc);
        ...
        try {
            if (requestId != null) {
                fwIssueHistoryDao.updateOTAHistory(EVENT_MESSAGE, deviceId, deviceType, openTime, saveResult, requestId);
            } else {
                fwIssueHistoryDao.updateOTAHistory(EVENT_MESSAGE, deviceId, deviceType, openTime, saveResult);
            }
            log.debug("updateOTAHistory commit finished.");
        } catch (Exception e) {
            log.error("ERROR on FirmwareIssueHistory update Transaction - " + e.getMessage(), e);
	 ...
	 */
	@Transactional(propagation=Propagation.REQUIRES_NEW)
	public void updateOTAHistory(String triggerId, String equipId, FW_OTA step, FW_STATE state, String errCode){
	 ...
	 */
	@Transactional(propagation=Propagation.REQUIRES_NEW)
	public void updateReDistHistory(List equipList, String triggerId,
