...
public interface CommandGWMBean
{
     ...
     *
     * @param mcuId MCU Indentifier
     * @param String modemId (stringEntry)
     * @param int msgTimeout
     * @param int tunnelTimeout
     * @return moproperty
     * @throws FMPMcuException, Exception
     */
	public Hashtable cmdCreateTunnel(String mcuId, String modemId, 
			   int msgTimeout, int tunnelTimeout) 
		throws FMPMcuException, Exception;
	
    /**
     *  Create Bypass Tunnel 2
     *
     * @param mcuId MCU Indentifier
     ...
     * @throws FMPMcuException, Exception
     */
	public Hashtable cmdCreateTunnel2(String mcuId, String modemEuiId, 
			   int msgTimeout, int tunnelTimeout) 
		throws FMPMcuException, Exception;
     ...
     * @throws FMPMcuException, Exception
     */
	public void cmdDeleteTunnel(String mcuId, String modemId) 
			throws FMPMcuException, Exception;
     ...
     * @throws FMPMcuException, Exception
     */
	public void cmdDeleteTunnel2(String mcuId, String modemEuiId) 
			throws FMPMcuException, Exception;
	
	/**
     * Get Bypass Tunnel Info
     *
     * @param mcuId MCU Indentifier
     * @param String[] modemId (eui64Entry)
     * @return List
...
//			               int cancelPolicy) throws FMPMcuException, Exception;
	...
	public Hashtable cmdReqImagePropagate(String mcuId, int upgradeType, int control,
			String imageKey, String imageUrl, String upgradeCheckSum, 
			String imageVersion, String targetModel , int cloneCount, List<String> filterValue) 
					throws FMPMcuException, Exception;
    ...
    public String coapPing(String ipAddress, String device, String type, java.lang.String protocol, java.lang.String fwVersion) throws Exception;
...
// 			throws FMPMcuException, Exception;
	 ...
	 * @throws FMPMcuException, Exception
	 */
	public MeterData cmdMeteringDataRequestNiCommand(String mcuId, String modemId, String meterId, String fromDate, String toDate) 
			throws FMPMcuException, Exception;
	 ...
	 * @throws FMPMcuException, Exception
	 */	
	public MeterData cmdGetDailyLoadProfile(String modemId, String meterId, String fromDate, String toDate) 
			throws Exception; 
	 ...
	 * @throws Exception
	 */	
	public Map<String, Object> cmdSTSNetCharge(String modemId, String meterId, String param)
			throws Exception;
}
