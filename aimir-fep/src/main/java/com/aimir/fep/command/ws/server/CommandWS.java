...
public class CommandWS
{
    ...
    /**
     *  Create Bypass Tunnel2
     *
     * @param mcuId MCU Indentifier
     * @param String modemId (eui64Entry)
     * @param int msgTimeout (10sec in normal)
     * @param int tunnel session Timeout (61sec in normal)
     * @return port(INT) or ErrorCode
     * @throws FMPMcuException, Exception
     */    
    @WebMethod(operationName="cmdCreateTunnel2")
    public ResponseMap cmdCreateTunnel2(@WebParam(name="McuId") String mcuId,
    		@WebParam(name="ModemEuiId") String modemEuiId,
    		@WebParam(name="MsgTimeout") int msgTimeout,
    		@WebParam(name="TunnelTimeout") int tunnelTimeout    		 
    		)    
    				throws Exception
	{
		ResponseMap response = new ResponseMap();
		response.setResponse(this.command.cmdCreateTunnel2(mcuId, modemEuiId, msgTimeout, tunnelTimeout));
		return response; 
	}
     ...
     */    
    @WebMethod
    public void cmdDeleteTunnel2(@WebParam(name="McuId") String mcuId,
    		@WebParam(name="ModemEuiId") String modemEuiId
    		)
    		throws Exception
    {
    	this.command.cmdDeleteTunnel2(mcuId, modemEuiId);
    }
    
    
    /**
     * Get Bypass Tunnel Information
     *
     * @param mcuId MCU Indentifier
     * @param String[] modemId (List of eui64Entry)
     * @return list[ id, msgTimeout, tunnelTimeout, portNumber, createTime, lastTimestamp, 
     *               sendPacket, sendBytes, recvPackets, recvBytes ]
     * @throws FMPMcuException, Exception
     */    
    @WebMethod
    public List<TunnelListInfo> cmdGetTunnelList(@WebParam(name="McuId") String mcuId,
    		@WebParam(name="ModemEuiId") String[] modemEuiId
    		)
    		throws Exception
    {
    	return this.command.cmdGetTunnelList(mcuId, modemEuiId);
    }
...
//        response.setResponse(command.cmdMultiFirmwareOTA(OTATargetType.valueOf(otaTargetType), deviceList, take_over, useNullBypass, firmwareId));
    ...
    {
        ResponseMap response = new ResponseMap();
        response.setResponse(command.cmdMeterParamGet(modemId, meterId, param));
        return response;
    }
    ...
    {
        ResponseMap response = new ResponseMap();
        response.setResponse(command.cmdMeterParamSet(modemId, meterId, param));
        return response;
    }
    ...
    {
        ResponseMap response = new ResponseMap();
        response.setResponse(command.cmdMeterParamAct(modemId, meterId, param));
        return response;
    }
    ...
    {
        ResponseMap response = new ResponseMap();
        response.setResponse(command.cmdGetPowerFailureLog(modemId, meterId, fromDate, toDate ));
        return response;
    }
     ...
     */
    @WebMethod
    public ResponseMap cmdGetFraudDetectionLog(
    		@WebParam(name="ModemId") String modemId,
    		@WebParam(name="MeterId") String meterId,
    		@WebParam(name="FromDate") String fromDate,
    		@WebParam(name="ToDate") String toDate ) throws Exception
    {
        ResponseMap response = new ResponseMap();
        response.setResponse(command.cmdGetFraudDetectionLog(modemId, meterId, fromDate, toDate ));
        return response;
    }
    
    /**
     *  DLMS Get DisconnectorControlLog
     * @param modemId
     * @param param
     * 
     * @return
     ...
     */
    @WebMethod
    public ResponseMap cmdGetDisconnectorControlLog(
    		@WebParam(name="ModemId") String modemId,
    		@WebParam(name="MeterId") String meterId,
    		@WebParam(name="FromDate") String fromDate,
    		@WebParam(name="ToDate") String toDate ) throws Exception
    {
        ResponseMap response = new ResponseMap();
        response.setResponse(command.cmdGetDisconnectorControlLog(modemId, meterId, fromDate, toDate ));
        return response;
    }
    ...
    {
        ResponseMap response = new ResponseMap();
        response.setResponse(command.cmdGetStandardEventLog(modemId, meterId, fromDate, toDate ));
        return response;
    }
...
//            MeterData md = command.cmdDmdNiGetRomRead(mcuId, meterId, modemId, fromDate, toDate);
    ...
    public MeterData cmdMeteringDataRequestNiCommand(
            @WebParam(name="McuId") String mcuId, 
            @WebParam(name="ModemId") String modemId,
            @WebParam(name="MeterId") String meterId,
            @WebParam(name="FromDate") String fromDate, 
                    ...
                    throws Exception
    {
        log.info("fromDate[" + fromDate + "] toDate[" + toDate +"]");
        try {
            MeterData md = command.cmdMeteringDataRequestNiCommand(mcuId, modemId, meterId, fromDate, toDate);
            return md;
        }
        catch (Exception e) {
            throw e;
    ...
    public ResponseMap cmdNIBypassMeterInterface(
            @WebParam(name="ModemId") String modemId,
            @WebParam(name="MeterId") String meterId,
            @WebParam(name="RequestType") String requestType,
            @WebParam(name = "Uart") int uArt
    		) throws Exception
    {
    	try {
    		ResponseMap response = new ResponseMap();
    		response.setResponse(command.cmdNIBypassMeterInterface(modemId, meterId, requestType, uArt));
            return response;
        }
        catch (Exception e) {
            throw e;
    ...
    @WebMethod
    public MeterData cmdGetMonthlyBillingEventLog(
    		@WebParam(name="ModemId") String modemId,
    		@WebParam(name="MeterId") String meterId,
    		@WebParam(name="FromDate") String fromDate,
    		@WebParam(name="ToDate") String toDate
    ...
    {
    	 log.info("cmdGetMonthlyBillingEventLog :: modemId["+ modemId +"] meterId["+ meterId +"] fromDate[" + fromDate + "] toDate[" + toDate +"]");
         try {
             MeterData md = command.cmdGetMonthlyBillingEventLog(modemId, meterId, fromDate, toDate);
             return md;
         }
         catch (Exception e) {
             throw e;
    ...
    @WebMethod
    public MeterData cmdGetDailyLoadProfile(
    		@WebParam(name="ModemId") String modemId,
    		@WebParam(name="MeterId") String meterId,
    		@WebParam(name="FromDate") String fromDate,
    		@WebParam(name="ToDate") String toDate
    ...
    {
    	 log.info("cmdGetDailyLoadProfile :: modemId["+ modemId +"] meterId["+ meterId +"] fromDate[" + fromDate + "] toDate[" + toDate +"]");
         try {
             MeterData md = command.cmdGetDailyLoadProfile(modemId, meterId, fromDate, toDate);
             return md;
         }
         catch (Exception e) {
             throw e;
    ...
    @WebMethod
    public ResponseMap cmdSTSGeneralCommand( 
            @WebParam(name="ModemId") String modemId,
            @WebParam(name="MeterId") String meterId,
            @WebParam(name="RequestType") String requestType,
            @WebParam(name = "Param") String param
    ...
    {
    	log.info("cmdSTSGeneralCommand :: modemId["+ modemId +"] meterId["+ meterId +"] requestType[" + requestType + "] param[" + param +"]");
    	ResponseMap response = new ResponseMap();
    	try {
    		response.setResponse(command.cmdSTSGeneralCommand(modemId, meterId, requestType, param));
    		return response;
    	}catch (Exception e) {
            throw e;
        }
    ...
    @WebMethod
    public ResponseMap cmdSTSBlockTariff( 
            @WebParam(name="ModemId") String modemId,
            @WebParam(name="MeterId") String meterId,
            @WebParam(name="RequestType") String requestType,
            @WebParam(name = "Param") String param
    ...
    {
    	log.info("cmdSTSBlockTariff :: modemId["+ modemId +"] meterId["+ meterId +"] requestType[" + requestType + "] param[" + param +"]");
    	ResponseMap response = new ResponseMap();
    	try {
    		response.setResponse(command.cmdSTSBlockTariff(modemId, meterId, requestType, param));
    		return response;
    	}catch (Exception e) {
            throw e;
        }
    ...
    @WebMethod
    public ResponseMap cmdSTSNetCharge(
    		@WebParam(name="ModemId") String modemId, 
    		@WebParam(name="MeterId") String meterId, 
    		@WebParam(name = "Param") String param
    		) throws Exception {
    	...
    	ResponseMap response = new ResponseMap();
    	try {
    		response.setResponse(command.cmdSTSNetCharge(modemId, meterId, param));
    		return response;
    	}catch (Exception e) {
            throw e;
        }
