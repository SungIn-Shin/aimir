...
public class TOU_BLOCK implements java.io.Serializable {
	...
	public TOU_BLOCK(int nbr_summation, 
					 ...
					 int nbr_curr_demand, 
					 int nbr_coin) {
		this.summations        = new ArrayList<Object>(nbr_summation);
		this.event_time        = new ArrayList<Object>(nbr_eventtime);
		this.cumulative_demand = new ArrayList<Object>(nbr_cumdemand);
		this.current_demand    = new ArrayList<Object>(nbr_curr_demand);
		this.coincidents       = new ArrayList<Object>(nbr_coin);
	}
