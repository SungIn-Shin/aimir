...
public class SaveAllReqParameterValidator {
    ...
    public static void validator( AuthCred authCred, CMSEnt cmsEnt, String saveAllType)
    	...
    	if(cmsEnt.getCustomer() != null){
    		...
    		// 2017.11.27 WriteDate 설정
    		cmsEnt.getCustomer().setWriteDate(writeDate);
    	...
    	if(cmsEnt.getSerivcePoint() != null){
    		...
    		// 2017.11.27 WriteDate 설정
    		cmsEnt.getSerivcePoint().setWriteDate(writeDate);
    		...
    		*/
            ...
            // 2018.03.13 추가됨.
            if (cmsEnt.getSerivcePoint().getDigitalAddress() == null)
                cmsEnt.getSerivcePoint().setDigitalAddress("");
            
            if (cmsEnt.getSerivcePoint().isExist() == null)
                cmsEnt.getSerivcePoint().setExist(false);
            
            // 2017.11.27 WriteDate 설정
            if (cmsEnt.getSerivcePoint().getMeter() != null) {
            	cmsEnt.getSerivcePoint().getMeter().setWriteDate(writeDate);
            }
