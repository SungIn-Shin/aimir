...
public class BatteryLogManagerImpl implements BatteryLogManager{
    ...
    public List<Object> getModemTypeCombo() {
        ...
        resultMap.put("id", ModemType.ZBRepeater);
        resultMap.put("name", ModemType.ZBRepeater.name());
    ...
    public Map<String, Object> getBatteryLogList(Map<String, Object> condition) {
        ...
        if ("".equals(modemType)) {
            ...
            modemTypes.add(CommonConstants.ModemType.ZBRepeater.toString());

            condition.put("modemType", CommonConstants.ModemType.ZEUPLS.toString());
            result.put("chart1", getBatteryLog(condition));
            condition.put("modemType", CommonConstants.ModemType.ZBRepeater.toString());
