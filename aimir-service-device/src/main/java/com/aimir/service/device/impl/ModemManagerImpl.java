...
public class ModemManagerImpl implements ModemManager {
	...
	public Object getModemByType(Map<String, Object> condition) throws Exception {
		...
		else if (modemType.equals(ModemType.ZEUMBus.toString()))
			rtnModem = zeumbusDao.get(modemId);
		else if (modemType.equals(ModemType.ZBRepeater.toString()))
			rtnModem = zbrepeaterDao.get(modemId);
		else if (modemType.equals(ModemType.Converter.toString()))
	...
	public List<Object> getModemSearchGrid2(Map<String, Object> condition, String gridType) {
		...
		String location = (String) condition.get("sLocationId");
		// 공급지역 검색 조건 시 - 최하위 노드 값 조회 및 설정
		if (condition.get("sLocationId") != null
				&& !((String) condition.get("sLocationId")).trim().equals("")) {
			List<Integer> locations = locationDao.getLeafLocationId(Integer
...
*/
	...
	public void copyModemField(Modem src, Modem dest){
		...
		dest.setProtocolVersion(src.getProtocolVersion());
	...
	public List<Map<String,Object>> getSTSModem(Map<String,Object> condition) throws Exception {
		return modemDao.getSTSModem(condition);
	}
    ...
    public List<String> getDeviceList2(Map<String, Object> condition){
    	List<String> deviceList = modemDao.getDeviceList2(condition);
    	return deviceList;
    }
    ...
    public List<String> getTargetList2(Map<String, Object> condition){
    	List<String> deviceList = modemDao.getTargetList2(condition);
    	return deviceList;
    }
