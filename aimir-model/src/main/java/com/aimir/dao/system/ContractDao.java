...
public interface ContractDao extends GenericDao<Contract, Integer>{
    ...
    public List<Map<String, Object>> getPrepaymentChargeContractList2(Map<String, Object> conditionMap, boolean isCount);
    ...
    /**
     * method name : abnormalDeductionDetailView, prepaymentLogDetailView, trackCustomerChargeDetailView, loadProfileDetailView
	...
	/**
	 * @method  : getPrepaymentInfoList
	 * @desc	: MDSID, ContractNumber등으로 고객 및 미터 정보를 조회한다.
	 */
	public List<Map<String, Object>> getPrepaymentInfoList(Map<String, Object> conditionMap, boolean b);
}