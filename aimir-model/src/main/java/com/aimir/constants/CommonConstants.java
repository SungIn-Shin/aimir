...
public class CommonConstants {
    ...
    public static Code getMeterStatusByName(String name) {
    	log.debug(" getMeterStatusByName("+ name +") Called ");
    	//log.debug(" meterStatuses.size() : " + meterStatuses.size());
    ...
    public static List<Code> getEventAlertTypes() {
        List<Code> eventAlertTypes = codeDao.getChildCodes(codeDao.getCodeByName("EventAlert").getCode());
    ...
    public static List<Code> getSeverityTypes() {
        return codeDao.getChildCodes(codeDao.getCodeByName("FM Severity").getCode());
    }
    ...
    public static List<Code> getEventStatuses() {
        return codeDao.getChildCodes(codeDao.getCodeByName("FM Status").getCode());
    }
