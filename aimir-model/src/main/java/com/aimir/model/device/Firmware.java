...
public class Firmware extends BaseObject {
    ...
    @ColumnInfo(name="NI_FW_VERSION", view=@Scope(create=true, read=true, update=true), descr="wasion meter 2byte fw version")
    @Column(name="NI_FW_VERSION", nullable=true, unique=false)
    private java.lang.String niFwVersion;
    ...
    public java.lang.String getNiFwVersion() {
		return niFwVersion;
	}

	public void setNiFwVersion(java.lang.String niFwVersion) {
		this.niFwVersion = niFwVersion;
	}
	...
	public boolean equals(Object obj) {
		...
		if (hwVersion == null) {
			...
			return false;
		if (niFwVersion == null) {
			if (other.niFwVersion != null)
				return false;
		} else if (!niFwVersion.equals(other.niFwVersion))
			return false;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((niFwVersion == null) ? 0 : niFwVersion.hashCode());
		result = prime * result
