...
public class CheckBalanceSettingWSModify extends BaseObject {
    ...
    @Id
    @TableGenerator(name="CHECK_BALANCE_SETTING_WS_ID_GEN", table="CHECK_BALANCE_SETTING_WS_ID", allocationSize=1,
            pkColumnName="SEQUENCE_NAME", valueColumnName="SEQUENCE_NEXT_HI_VALUE", pkColumnValue="CHECK_BALANCE_SETTING_WS") 
    @GeneratedValue(strategy=GenerationType.SEQUENCE, generator="CHECK_BALANCE_SETTING_WS_ID_GEN")
	private Integer id;
