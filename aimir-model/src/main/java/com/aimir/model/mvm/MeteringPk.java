...
public abstract class MeteringPk extends BasePk{
	...
	/*public void setMDevType(Integer mdevType) {	
	    for (DeviceType deviceType : DeviceType.values()) {
	        if (deviceType.getCode() == mdevType)
	...
	public static void main(String[] args) {
		...
		System.out.println("1 : " + DeviceType.Modem);
		System.out.println("2 : " + DeviceType.valueOf(mdev));
		
		if(DeviceType.Modem.equals(mdev)){
			System.out.println("YES");
		}else{
			System.out.println("NO");
		}
		
		if(DeviceType.Modem.equals(DeviceType.valueOf(mdev))){
			System.out.println("YES");
		}else{
			System.out.println("NO");
		}
