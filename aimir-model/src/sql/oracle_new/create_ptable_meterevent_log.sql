...
BEGIN
  STMT_DDL := 'CREATE TABLE METEREVENT_LOG '||
              ...
              '  CONSTRAINT METEREVENT_LOG_PK PRIMARY KEY (OPEN_TIME, ACTIVATOR_ID, METEREVENT_ID) '||
              ') '||
  ...
  STMT_DDL := 'CREATE INDEX METEREVENT_LOG_IDX_01 ON METEREVENT_LOG(METEREVENT_ID, ACTIVATOR_ID, YYYYMMDD, OPEN_TIME) LOCAL TABLESPACE AIMIRPART';
  EXECUTE IMMEDIATE STMT_DDL;
