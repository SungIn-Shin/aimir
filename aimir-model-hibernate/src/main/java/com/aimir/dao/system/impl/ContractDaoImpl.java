...
//        if(!"".equals(sicId) && !sicId.equals("null")) query.setInteger("sicId", Integer.parseInt(sicId));
    ...
    public Map<String, Object> getContractInfo(int contractId) {
        ...
        sb.append("\n       c.isSts AS isSts, ");
        sb.append("\n       c.isNetMetering AS isNetMetering ");
        sb.append("\nFROM Contract c ");
...
//            result.add(map);
    ...
    */
    ...
    /**
     * method name : getAbnormalDeductionList
     * method Desc : Prepayment Customer Management 가젯에서 Abnormal Deduction Customer List 를 조회한다.
     *
     * @param conditionMap
     * @return
     */
    ...
    public List<Map<String, Object>> getAbnormalDeductionList(Map<String, Object> conditionMap, boolean isCount) {
        List<Map<String, Object>> result;
        String startDate = StringUtil.nullToBlank(conditionMap.get("startDate"));
        String endDate = StringUtil.nullToBlank(conditionMap.get("endDate"));
//        Integer contractId = (Integer)conditionMap.get("contractId");
        Integer contractId = conditionMap.get("contractId") != null ? Integer.parseInt(conditionMap.get("contractId").toString()) : 0;
        String customerNo = StringUtil.nullToBlank(conditionMap.get("customerNo"));
        String customerName = StringUtil.nullToBlank(conditionMap.get("customerName"));
        String mdsId = StringUtil.nullToBlank(conditionMap.get("mdsId"));
        Integer page = (Integer)conditionMap.get("page");
...
//            sb.append("\n       P.USED_CONSUMPTION,");
        ...
        sb.append("\nFROM CONTRACT C INNER JOIN METER M ON C.METER_ID=M.ID ");
        sb.append("\n     INNER JOIN BILLING_BLOCK_TARIFF B ON C.ID = B.CONTRACT_ID ");
//        sb.append("\n     INNER JOIN PREPAYMENTLOG P ON C.ID = P.CONTRACT_ID ");
        sb.append("\n     INNER JOIN CUSTOMER CM ON C.CUSTOMER_ID = CM.ID ");

        sb.append("\nWHERE C.CURRENTCREDIT < 0 ");
        sb.append("\nAND  B.BILL > 500 ");
        ...
        if (!mdsId.isEmpty()) {
            sb.append("\nAND   C.METER_ID LIKE '%'||:mdsId||'%' ");
        }
        if (!customerNo.isEmpty()) {
            sb.append("\nAND   C.CUSTOMER_ID LIKE '%'||:customerNo||'%' ");
        }
        if (!customerName.isEmpty()) {
            sb.append("\nAND   CM.NAME LIKE '%'||:customerName||'%' ");
        }
        if (!startDate.isEmpty()) {
            sb.append("\nAND   C.LASTTOKENDATE >= :startDate ");
        }
        if (!endDate.isEmpty()) {
            sb.append("\nAND   C.LASTTOKENDATE <= :endDate ");
        }
        if (!isCount) {
            sb.append("\nORDER BY C.LASTTOKENDATE DESC ");
        }
        Query query = null;
        try{
	        query = getSession().createSQLQuery(sb.toString());
	        ...
	        if (isCount) {
	            ...
	            query.setMaxResults(limit);
	            result = query.setResultTransformer(Transformers.ALIAS_TO_ENTITY_MAP).list();
	            System.out.println("Return Dao result Log"+query.setResultTransformer(Transformers.ALIAS_TO_ENTITY_MAP).list());
	        }
        }catch(Exception e) {
        	logger.error(e,e);
        	result = new ArrayList<Map<String, Object>>();
    ...
    /**
     * method name : deductionDetailView
     * method Desc : Abnormal Deduction Customer List 에서 선택된 그리드내 contractId 에 해당하는 DetailView Popup 을 조회한다.
     *
     * @param conditionMap
     * @return
     */
    ...
    @Override
    @Transactional(value = "transactionManager", readOnly=true, propagation=Propagation.REQUIRES_NEW)
	public List<Map<String, Object>> deductionDetailView(Map<String, Object> conditionMap, boolean isCount) {
    	List<Map<String, Object>> result;
    	Integer contractId = conditionMap.get("contractId") != null ? Integer.parseInt(conditionMap.get("contractId").toString()) : 0;
        Integer page = (Integer)conditionMap.get("page");
        Integer limit = (Integer)conditionMap.get("limit");
        ...
        if(isCount) {
            sb.append("\nSELECT count(B.CONTRACT_ID) as total");
        } else {
            sb.append("\nSELECT B.CONTRACT_ID, ");
            sb.append("\n       B.ACCUMULATEBILL, ");
            sb.append("\n       B.ACCUMULATEUSAGE, ");
            sb.append("\n       B.ACTIVEENERGY, ");
            sb.append("\n       B.ACTIVEENERGYEXPORT, ");
            sb.append("\n       B.ACTIVEENERGYIMPORT, ");
            sb.append("\n       B.BALANCE, ");
            sb.append("\n       B.BILL, ");
            sb.append("\n       B.HHMMSS, ");
            sb.append("\n       B.MDEV_ID, ");
            sb.append("\n       B.REACTIVEENERGYEXPORT, ");
            sb.append("\n       B.REACTIVEENERGYIMPORT, ");
            sb.append("\n       B.USAGE, ");
            sb.append("\n       B.WRITEDATE, ");
            sb.append("\n       B.YYYYMMDD, ");
            sb.append("\n       B.SUPPLIER_ID, ");
    ...
    /**
     * method name : prepaymentLogDetailView
     * method Desc : Abnormal Deduction Customer List 에서 선택된 그리드내 contractId 에 해당하는 DetailView Popup 을 조회한다.
     *
     * @param conditionMap
     * @return
    ...
    @Override
    @Transactional(value = "transactionManager", readOnly=true, propagation=Propagation.REQUIRES_NEW)
	public List<Map<String, Object>> prepaymentLogDetailView(Map<String, Object> conditionMap, boolean isCount) {
    	List<Map<String, Object>> result;
    	Integer contractId = conditionMap.get("contractId") != null ? Integer.parseInt(conditionMap.get("contractId").toString()) : 0;
        String mdsId = StringUtil.nullToBlank(conditionMap.get("mdsId"));
        Integer page = (Integer)conditionMap.get("page");
        ...
        if(isCount) {
            ...
            sb.append("\nSELECT P.ID, ");
            sb.append("\n       P.CONTRACT_ID, ");
            sb.append("\n       P.ACTIVE_ENERGY_EXPORT, ");
            sb.append("\n       P.ACTIVE_ENERGY_IMPORT, ");
            sb.append("\n       P.ARREARS, ");
            sb.append("\n       P.BALANCE, ");
            sb.append("\n       P.CANCEL_DATE, ");
            sb.append("\n       P.CANCEL_TOKEN, ");
            ...
            sb.append("\n       P.LIFELINESUBSIDY, ");
            sb.append("\n       P.LOCATION_ID, ");
            sb.append("\n       P.MONTHLYSERVICECHARGE, ");
            sb.append("\n       P.MUNICIPALITYCODE_ID, ");
            sb.append("\n       P.PARTPAYINFO, ");
            sb.append("\n       P.PAY_TYPE_CODE, ");
            sb.append("\n       P.POWER_LIMIT, ");
            sb.append("\n       P.PRE_ARREARS, ");
        ...
        sb.append("\nFROM PREPAYMENTLOG P INNER JOIN TARIFFTYPE T ON P.TARIFFINDEX_ID = T.ID");

        if (contractId > 0) {
        	sb.append("\nAND   P.CONTRACT_ID = :contractId ");
        }
        if (!startDate.isEmpty()) {
            sb.append("\nAND   P.LASTTOKENDATE >= :startDate ");
        }
        if (!endDate.isEmpty()) {
            sb.append("\nAND   P.LASTTOKENDATE <= :endDate ");
        }
        if (!isCount) {
    ...
    /**
     * method name : trackCustomerChargeDetailView
     * method Desc : Abnormal Deduction Customer List 에서 선택된 그리드내 contractId 에 해당하는 DetailView Popup 을 조회한다.
     *
     * @param conditionMap
     * @return
    ...
    @Override
    @Transactional(value = "transactionManager", readOnly=true, propagation=Propagation.REQUIRES_NEW)
	public List<Map<String, Object>> trackCustomerChargeDetailView(Map<String, Object> conditionMap, boolean isCount) {
    	List<Map<String, Object>> result;
    	Integer contractId = conditionMap.get("contractId") != null ? Integer.parseInt(conditionMap.get("contractId").toString()) : 0;
        String mdsId = StringUtil.nullToBlank(conditionMap.get("mdsId"));
        Integer page = (Integer)conditionMap.get("page");
        ...
        sb.append("\nFROM CONTRACTCHANGELOG CH INNER JOIN OPERATOR O ON CH.OPERATOR_ID = O.ID ");
        sb.append("\n     INNER JOIN CUSTOMER CT ON CH.CUSTOMER_ID = CT.ID ");
        sb.append("\nWHERE 1=1 ");

        if (contractId > 0) {
        	sb.append("\nAND   ch.CONTRACT_ID = :contractId ");
        }
        if (!startDate.isEmpty()) {
            sb.append("\nAND   CH.WRITEDATETIME >= :startDate ");
        }
        if (!endDate.isEmpty()) {
            sb.append("\nAND   CH.WRITEDATETIME <= :endDate ");
        }
        if (!isCount) {
            sb.append("\nORDER BY CH.WRITEDATETIME DESC ");
        }
        Query query = null;
        try{
	        query = getSession().createSQLQuery(sb.toString());
    ...
    /**
     * method name : loadProfileDetailView
     * method Desc : Abnormal Deduction Customer List 에서 선택된 그리드내 contractId 에 해당하는 DetailView Popup 을 조회한다.
     *
     * @param conditionMap
     * @return
    ...
    @Override
    @Transactional(value = "transactionManager", readOnly=true, propagation=Propagation.REQUIRES_NEW)
	public List<Map<String, Object>> loadProfileDetailView(Map<String, Object> conditionMap, boolean isCount) {
    	List<Map<String, Object>> result;
    	Integer contractId = conditionMap.get("contractId") != null ? Integer.parseInt(conditionMap.get("contractId").toString()) : 0;
        String mdsId = StringUtil.nullToBlank(conditionMap.get("mdsId"));
        Integer page = (Integer)conditionMap.get("page");
        ...
        if(isCount) {
            sb.append("\nSELECT count(CONTRACT_ID) as total");
        } else {
            sb.append("\nSELECT LP.CONTRACT_ID, ");
            sb.append("\n       LP.CHANNEL, ");
            sb.append("\n       LP.DST, ");  
            sb.append("\n       LP.MDEV_ID, ");
            sb.append("\n       LP.MDEV_TYPE, ");
        ...
        sb.append("\nFROM LP_EM LP, DISPLAY_CHANNEL D");
        sb.append("\nWHERE 1=1 ");
        sb.append("\n  	AND LP.CHANNEL = D.ID");
        sb.append("\n	AND LP.CHANNEL IN (1, 2) ");

        if (contractId != 0) {
        	sb.append("\nAND   LP.CONTRACT_ID = :contractId ");
        }
        if (!startDate.isEmpty()) {
            sb.append("\nAND   LP.WRITEDATE >= :startDate ");
        }
        if (!endDate.isEmpty()) {
            sb.append("\nAND   LP.WRITEDATE <= :endDate ");
        }
        if (!isCount) {
            sb.append("\nORDER BY LP.WRITEDATE DESC ");
        }
        Query query = null;
        try{
	        query = getSession().createSQLQuery(sb.toString());
    ...
    /**
     * method name : recoverDeduction
     * method Desc : 과차감 데이터를 복구 테이블로 이동한다.
     *
     * @param contractId
     * @param date
     * @return
     */
    @Override
    @Transactional(value = "transactionManager", readOnly=true, propagation=Propagation.REQUIRES_NEW, rollbackFor = {Exception.class,DataAccessException.class,SQLException.class})
    public int recoverDeduction(String contractId, String date) {
    	 int count1 = 0;
    	 int count2 = 0;
    	 Date now = new Date();
    	 ...
    	 sb1.append("\n INSERT INTO BillingBlockTariffRecover (  ");
         sb1.append("\n     hhmmss,	                          		");
         sb1.append("\n     mdevId,	                        	");
         sb1.append("\n     mdevType,	                      		");
         sb1.append("\n     yyyymmdd,	                        	");
       ...
       //PrepaymentLog
         sb2.append("\n INSERT INTO PrepaymentLogRecover ( ");
         sb2.append("\n     id,                             ");
         sb2.append("\n     additionalSubsidy,              ");
         sb2.append("\n     arrears,                        ");
         sb2.append("\n     authCode,                       ");
         ...
         sb2.append("\n WHERE contractId = 				      ");
         sb2.append("\n '"+ contractId +"'" );
         sb2.append("\n   AND lastTokenDate IN ( 			       ");
         sb2.append("\n '"+ date +"' )" );
         
         Query query1 = getSession().createQuery(sb1.toString());
         Query query2 = getSession().createQuery(sb2.toString());
         
//         query1.setEntity("contractId", contractId);
//         query1.setEntity("date", date);

//         query2.setEntity("contractId", contractId);
//         query2.setEntity("date", date);
    ...
    /**
     * method name : deleteDeduction
     * method Desc : 과차감 데이터를 삭제한다.
     *
     * @param String[] contractArr - contractId 배열
     * @return
     */
    @Override
    @Transactional(value = "transactionManager", readOnly=true, propagation=Propagation.REQUIRES_NEW, rollbackFor = {Exception.class,DataAccessException.class,SQLException.class})
    public int deleteDeduction(String contractId, String date) {
    	 int count1 = 0;
    	 int count2 = 0;
    	 ...
    	 //PrepaymentLog
         sb1.append("\n DELETE FROM PrepaymentLog ");
//         sb1.append("\n WHERE CONTRACT_ID = :contractId ");
         sb1.append("\n WHERE CONTRACT_ID ='"+ contractId +"' ");
         sb1.append("\n AND CHARGEDCREDIT is null ");
         sb1.append("\n AND  LASTTOKENDATE IN ( ");
         sb1.append("\n '"+ date +"'" );
         sb1.append(" )");
         
         //billing_block_tariff
         sb2.append("\n DELETE FROM BillingBlockTariff ");
//       sb2.append("\n WHERE CONTRACT_ID = :contractId ");
         sb2.append("\n WHERE CONTRACT_ID ='"+ contractId +"' ");
         sb2.append("\n AND  WRITEDATE IN ( ");
         sb2.append("\n '"+ date +"'" );
...
//         query1.setString(1, contractId);
//         query1.setString(2, date);
//         query2.setEntity("contractId", contractId);
    ...
    /**
     * method name : getRecoveryHistoryList
     * method Desc : Prepayment Customer Management 가젯에서 Recoverd History List 를 조회한다.
     *
     * @param conditionMap
     * @return
     */
    ...
    @Override
    @Transactional(value = "transactionManager", readOnly=true, propagation=Propagation.REQUIRES_NEW)
	public List<Map<String, Object>> getRecoveryHistoryList(Map<String, Object> conditionMap, boolean isCount) {
    	List<Map<String, Object>> result;
//    	String contractId = StringUtil.nullToBlank(conditionMap.get("contractId"));
    	Integer contractId = conditionMap.get("contractId") != null ? Integer.parseInt(conditionMap.get("contractId").toString()) : 0;
        String mdsId = StringUtil.nullToBlank(conditionMap.get("mdsId"));
        String deleteStatusId = StringUtil.nullToBlank(conditionMap.get("deleteStatusId"));
        String startDate = StringUtil.nullToBlank(conditionMap.get("startDate"));
        String endDate = StringUtil.nullToBlank(conditionMap.get("endDate"));
        Integer page = (Integer)conditionMap.get("page");
        Integer limit = (Integer)conditionMap.get("limit");
...
//            sb.append("\n       P.USED_CONSUMPTION, ");
        ...
        sb.append("\nFROM CONTRACT C INNER JOIN METER M ON C.METER_ID=M.ID ");
        sb.append("\n     INNER JOIN BILLING_BLOCK_TARIFF_RECOVER B ON C.ID = B.CONTRACT_ID ");
//        sb.append("\n     INNER JOIN PREPAYMENTLOG_RECOVER P ON C.ID = P.CONTRACT_ID ");
        sb.append("\n     INNER JOIN CUSTOMER CM ON C.CUSTOMER_ID = CM.ID ");
//        sb.append("\n     AND P.LASTTOKENDATE = B.WRITEDATE ");

       // sb.append("\nWHERE P.LASTTOKENDATE BETWEEN :startDate AND :endDate ");
        sb.append("\nWHERE 1=1 ");

        if (contractId > 0) {
        	sb.append("\nAND   C.ID = :contractId ");
        }
        if (!deleteStatusId.isEmpty()) {
        	if(("1").equals(deleteStatusId)) {
//        		sb.append("\nAND P.IS_DELETE = 'Y'AND B.IS_DELETE = 'Y' ");
        		sb.append("\nAND B.IS_DELETE = 'Y' ");
        	}else if(("2").equals(deleteStatusId)){
//        		sb.append("\nAND P.IS_DELETE = 'N'AND B.IS_DELETE = 'N' ");
        		sb.append("\nAND B.IS_DELETE = 'N' ");
        	}
        }
        if (!mdsId.isEmpty()) {
    ...
    /**
     * method name : recoveryHistoryUndo
     * method Desc : Recoverd History List의 Recoverd data 를 되돌린다.
     *
     * @param conditionMap
     * @return
     */
    @Override
    @Transactional(value = "transactionManager", readOnly=true, propagation=Propagation.REQUIRES_NEW, rollbackFor = {Exception.class,DataAccessException.class,SQLException.class})
    public int recoveryHistoryUndo(Map<String, Object> conditionMap) {
    	String contractId = StringUtil.nullToBlank(conditionMap.get("contractId"));
    	String date = StringUtil.nullToBlank(conditionMap.get("writeDate"));
   	 	StringBuffer sb = new StringBuffer();
	   	 int count1 = 0;
		 int count2 = 0;
		...
		//billing_block_tariff
    	 sb1.append("\n INSERT INTO BillingBlockTariff (  ");
         sb1.append("\n     hhmmss,	                          		");
         sb1.append("\n     mdevId,	                        	");
         sb1.append("\n     mdevType,	                      		");
         sb1.append("\n     yyyymmdd,	                        	");
         ...
         sb1.append("\n FROM BillingBlockTariffRecover	            ");
         sb1.append("\n WHERE contractId = 				      ");
         sb1.append("\n '"+ contractId +"'" );
         sb1.append("\n   AND writeDate IN ( 			       ");
         sb1.append("\n '"+ date +"' )" );
...
//	     query2.setEntity("date", date);
    ...
    /**
     * method name : recoveryHistoryUndo
     * method Desc : Recoverd History List의 IS_DELETE/LAST_MODIFY_DATE 를 업데이트 한다.
     *
     * @param conditionMap
     * @return
     */
    @Override
    @Transactional(value = "transactionManager", readOnly=true, propagation=Propagation.REQUIRES_NEW, rollbackFor = {Exception.class,DataAccessException.class,SQLException.class})
    public int recoveryHistoryUpdate(Map<String, Object> conditionMap) {
    	String contractId = StringUtil.nullToBlank(conditionMap.get("contractId"));
    	String date = StringUtil.nullToBlank(conditionMap.get("writeDate"));
    	 int count1 = 0;
    	 int count2 = 0;
    	 ...
    	 //BILLING_BLOCK_TARIFF_RECOVER
         sb1.append("\n UPDATE BillingBlockTariffRecover ");
         sb1.append("\n SET  IS_DELETE = 'Y' ");
         sb1.append("\n WHERE CONTRACT_ID ='"+ contractId +"' ");
         sb1.append("\n AND WRITEDATE IN ( ");
         sb1.append("\n 	SELECT writeDate FROM BillingBlockTariffRecover ");
         sb1.append("\n 	WHERE contractId ='"+ contractId +"' ");
         sb1.append("\n 	AND writeDate ='"+ date +"' ");
         sb1.append(" )");
         
         //PREPAYMENTLOG_RECOVER
         sb2.append("\n UPDATE PrepaymentLogRecover ");
         sb2.append("\n SET  IS_DELETE = 'Y' ");
         sb2.append("\n WHERE CONTRACT_ID ='"+ contractId +"' ");
         sb2.append("\n AND LASTTOKENDATE IN ( ");
         sb2.append("\n 	SELECT lastTokenDate FROM PrepaymentLogRecover ");
         sb2.append("\n 	WHERE contractId ='"+ contractId +"' ");
...
//         query2.setEntity("contractId", contractId);
    ...
    // 기존 동일한 쿼리, 필요한 항목을 일부 추가
    public List<Map<String, Object>> getPrepaymentChargeContractList2(Map<String, Object> condition, boolean isCount) {
        List<Map<String, Object>> result;
//        Integer supplierId = (Integer)condition.get("supplierId");
        ...
        if(isCount) {
            ...
            sb.append("\n       cont.currentCredit AS CURRENTCREDIT, ");
            sb.append("\n       cont.currentArrears AS CURRENTARREARS, ");
            sb.append("\n       cont.service_point_id AS SERVICEPOINT, ");
            sb.append("\n       cust.customerNo AS CUSTOMERNO, ");
    ...
    //        sb.append("\n       cust.address3 AS ADDRESS3, ");
        ...
        sb.append("\nAND cont.supplier_id is not null");
...
//	        query.setInteger("supplierId", supplierId);
    ...
    //미터아이디, 고객번호등으로 선불정보를 조회한다.
    public List<Map<String, Object>> getPrepaymentInfoList(Map<String, Object> condition, boolean isCount) {
        List<Map<String, Object>> result;
//        Integer supplierId = (Integer)condition.get("supplierId");
        String contractNumber = StringUtil.nullToBlank(condition.get("contractNumber"));
        String customerNo = StringUtil.nullToBlank(condition.get("customerNo"));
        ...
        if(isCount) {
            ...
            sb.append("\nSELECT cont.contract_Number AS CONTRACTNUMBER, ");
            sb.append("\n       cont.service_point_id AS SERVICEPOINT, ");
            sb.append("\n       cust.customerNo CUSTOMERNO, ");
            sb.append("\n       meter.mds_Id AS MDSID, ");
        ...
        sb.append("\n     Modem modem on(meter.modem_id = modem.id) ");
        sb.append("\n     LEFT OUTER JOIN ");
        sb.append("\n     DEVICEMODEL device on(meter.devicemodel_id = device.id) ");
        sb.append("\n     LEFT OUTER JOIN ");
        sb.append("\n     Code stat on(cont.status_id = stat.id)");
        sb.append("\n     LEFT OUTER JOIN ");
        sb.append("\n     Code credit on(cont.credittype_id = credit.id)");
...
//        sb.append("\nAND   cont.supplier_id = :supplierId ");        
        ...
        if (!contractNumber.isEmpty()) {
            sb.append("\nAND   cont.contract_Number = :contractNumber ");
        }
        if (!customerNo.isEmpty()) {
