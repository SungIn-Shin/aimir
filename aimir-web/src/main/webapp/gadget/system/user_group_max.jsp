...
<div id=pane-user-viewPage>
   <form name="roleModel" id="roleModel" method='post'>
    ...
    <!-- 베이직 info 부분 start -->
      ...
      <tr>
      	<th class="bold"><fmt:message key="aimir.permittedYn"/><!-- 접속허용여부--></th>
        <td>
      ...
      <tr>
        ...
        <td>
          <input name="customerRole" id="customerRole" type="text" value="" class="border-trans" style="width:50px;">
         </td>
      </tr>
      <tr>
      ...
      <tr id="maxMeter"> 
        ...
        <th class="bold"><input type="text" id=maxMeters  style="width:100px;" value = 0> &nbsp;Maximum number of group command ('0'  is 'Unlimited')</th>
      </tr>
      <tr>
        ...
        $("#update").click(function() {
            ...
            if ( confirm(updateStr)){//"변경 하시겠습니까?") ) {
                ...
                var options = {
                    ...
                    url : '${ctx}/gadget/system/user_group_max.do?param=update'+'&'+'maxMeters='+maxMeters,
                    type : 'post',
                    datatype : 'json',
                    baseParams :{
                    	'maxMeters' : maxMeters,
