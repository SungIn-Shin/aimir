...
<%--     <applet name="MacAddress" code="NetIfApplet.class"
    ...
    <div id="menu">
        <ul>
            ...
            <li class="balanceManagerTab">
                <a href="#balanceManagerTab"><fmt:message key='aimir.balance'/> <fmt:message key='aimir.management'/></a>
            </li>
        ...
        <div id="balanceManagerTab" >
            <!--검색조건-->
            <form id="balanceManagerForm" class="searchoption-container">
                <div>
                    <span>
                        <fmt:message key='aimir.barcode'/>
                        <input id="balance_barcodeNumber" name="balance_barcodeNumber" type="text" style="width:110px;">
                    </span>
                </div>
                <div class="clear-form">
                    <span>
                        <fmt:message key="aimir.contractNumber"/>
                        <input id="balance_contractNumber" name="balance_contractNumber" type="text" style="width:110px;">
                    </span>
                    <span>
                        <fmt:message key="aimir.customername"/>
                        <input id="balance_customerName" name="balance_customerName" type="text" style="width:120px;">
                    </span>
                    <span>
                        <fmt:message key="aimir.customerid"/>
                        <input id="balance_customerNo" name="balance_customerNo" type="text" style="width:120px;">
                    </span>
                    <span>
                        <fmt:message key="aimir.meterid"/>
                        <input id="balance_mdsId" name="balance_mdsId" type="text" style="width:120px;">
                    </span>
                    <span id="balance_contractSearch" class="am_button margin-l10 margin-t1px">
                        <a class="on"><fmt:message key="aimir.button.search" /></a>
                    </span>
                    <span class="bold-font hidden current-deposit">
                        <fmt:message key="aimir.deposit"/>
            ...
            <!--검색조건 끝-->
            <div id="balanceManagerDiv"></div>
            <br><br>
          	<div id="balanceManagerDetailDiv" class="width_auto ">
				<div id="balanceManagementTabMenu">
					<ul>
						<li class="balnceTransferTab"><a href="#balnceTransferTab"><fmt:message key='aimir.balance'/> <fmt:message key='aimir.balance.transfer'/></a></li>
						<li class="balnceAdjustmentTab"><a href="#balnceAdjustmentTab"><fmt:message key='aimir.balance'/> <fmt:message key='aimir.balance.adjustment'/></a></li>
					</ul>

				<!-- <div class="box_blu padding20px" style="height: 400px;">
				<ul class="width" style="padding-bottom:330px">
                    <li class="padding">-->
                    <div id="balnceTransferTab" class="box_blu" style="height : 0">
                        <ul class="width" style="padding-bottom:330px">
                    	<li class="padding"> 
                    	<div class="bodyleft_meterinfo" style="height : 0">
                        	<div class="headspace">
							    <label class="check"><fmt:message key='aimir.balance'/> <fmt:message key='aimir.balance.transfer'/> To New <fmt:message key='aimir.contract'/> (<fmt:message key='aimir.balance.remittance'/>)</label>
							</div>
							<div class="box-bluegradation-meter" style="height: auto;">
							    <div class="padding20px" >
							        <form id="balanceTransferFormEdit">
							            <div class="w_auto">
							                <div>
							                    <table>
							                        <tr>
							                            <td class="withinput" style="width:115px;"><b><fmt:message key='aimir.set'/> <fmt:message key="aimir.contract"/></b></td>
							                            <td class="padding-l20px"><input type="text" id="contractNu" name="contractNu" class="width-140px"/></td>
							                            <td>
							                                <span><em class="am_button"><a onclick="checkContract();">
							                                <fmt:message key="aimir.button.check"/> <fmt:message key="aimir.contract"/></a></em>
							                                </span>
															<span id="contractCheckIcon"><label class="check"></label></span>
							                            </td>
							                        </tr>
							                    </table>
							                    <table><tr><td class="withinput" style="width:150px;">(<fmt:message key='aimir.balance.remittee'/>'s <fmt:message key='aimir.contractNumber'/>)</td></tr></table>
							                </div>
							
							                <div>
							                    <table class="w_auto">
							                    <tr>
						                            <td class="withinput" style="width:115px;"><b><fmt:message key='aimir.set'/> <fmt:message key="aimir.amount"/></b></td>
						                            <td class="padding-l20px"><input type="text" id="transferAmount" name="transferAmount" class="width-140px"/></td>
						                            <td>
						                                <span><em class="am_button"><a onclick="checkTransferAmount();">
						                                <fmt:message key="aimir.button.check"/> <fmt:message key="aimir.amount"/></a></em>
						                                </span>
						                                <span id="transferAmountCheckIcon"><label class="check"></label></span>
						                            </td>
						                        </tr>
												<tr>
							                        <td class="withinput" style="width:115px;"><b><fmt:message key="aimir.description"/></b></font></td>
						                            <td class="padding-l20px"><input type="text" id="descr" name="descr" class="width-140px"/></td>
						                        </tr>
							                    </table>
							                </div>
							            </div>
							...
							<div id="infoBtnList">
							    <div id="btn" class="meter-info-btn2">
							        <div style="display:block;" >
							            <ul><li><a href="javaScript:confirmTransfer();" class="on"><fmt:message key="aimir.button.confirm"/></a></li></ul>
							            <ul><li><a href="javaScript:resetTransferInfo();" class="on"><fmt:message key="aimir.cancel"/></a></li></ul>
							        </div>
							    </div>
							</div>
						</div>
                        <div class="bodyright_meterinfo">
                            <ul> 
                               <li id="meterInstallDiv" class="bodyright_meterinfo_leftmargin" >
								<div class="headspace"><span><label class="check"><fmt:message key='aimir.contract'/> <fmt:message key="aimir.info"/></label></div>
								<div class="box-bluegradation-meter">
									<div class="padding20px">
										<div class="w_auto">
											<!-- Remitter (S) -->
											<div class="headspace" style=" padding-right: 25px;"><span><label class="check"><fmt:message key='aimir.balance.remitter'/></label><br>
											<table class="wfree">
												<tr>	
													<th class="withinput" width="200px"><b><fmt:message key="aimir.customername"/></b></th>
													<td><span><input id="remitter_customerName" type="text" readonly></span></td>
												</tr>
												<tr>	
													<th class="withinput" width="200px"><b><fmt:message key="aimir.buildingMgmt.contractNumber"/></b></th>
													<td><span><input id="remitter_contractNumber" type="text" readonly></span></td>
												</tr>
												<tr>	
													<th class="withinput" width="200px"><b><fmt:message key="aimir.credit"/></b></th>
													<td><span><input id="remitter_currentCredit" type="text" readonly></span></td>
												</tr>
												<tr>	
													<th class="withinput" width="200px"><b><fmt:message key="aimir.arrears"/></b></th>
													<td><span><input id="remitter_currentArrears" type="text" readonly></span></td>
												</tr>
											</table>
											</div>
											<!-- Remitter (E) -->
							               ...
							               <!-- Recipient (S) -->
							               <div class="headspace"><span><label class="check"><fmt:message key='aimir.balance.remittee'/></label><br>
							               <table class="wfree">
												<tr>	
													<th class="withinput" width="200px"><b><fmt:message key="aimir.customername"/></b></th>
													<td><span><input id="recipient_customerName" type="text" readonly></span></td>
												</tr>
												<tr>	
													<th class="withinput" width="200px"><b><fmt:message key="aimir.buildingMgmt.contractNumber"/></b></th>
													<td><span><input id="recipient_contractNumber" type="text" readonly></span></td>
												</tr>
												<tr>	
													<th class="withinput" width="200px"><b><fmt:message key="aimir.credit"/></b></th>
													<td><span><input id="recipient_currentCredit" type="text" readonly></span></td>
												</tr>
												<tr>	
													<th class="withinput" width="200px"><b><fmt:message key="aimir.arrears"/></b></th>
													<td><span><input id="recipient_currentArrears" type="text" readonly></span></td>
												</tr>
											</table>
							               </div>
							               <!-- Recipient (E) -->
                ...
                <!-- <div class="box_blu padding20px " style="height: 400px;">
                     <ul class="width" style="padding-bottom:330px">
                      <li class="">  -->
                    <div id="balnceAdjustmentTab" class="box_blu" style="height : 0;">
                       <ul class="width" style="padding-bottom:330px">
                    	<li class="padding">
                    	<div class="bodyleft_meterinfo" style="height : 0">
                            <div class="headspace">
                                <label class="check"><fmt:message key='aimir.balance'/> <fmt:message key='aimir.balance.adjustment'/></label>
                            </div>
                            
                            <div class="box-bluegradation-meter" style="height: auto;">
                                <div class="padding20px" >
                                    <form id="balanceAdjustFormEdit">
                                        <div class="w_auto">
                                            <div>
                                                <table>
                                                    <tr>
                                                        <td class="withinput" style="width:115px;"><b>Set New <fmt:message key='aimir.balance'/></b></td>
                                                        <td class="padding-l20px"><input type="text" id="setBalance" name="setBalance" class="width-140px" onChange="javascript:balanceChange();"/></td>
                                                        <td>
                                                            <span><em class="am_button"><a onclick="countCalculation();">Calculation</a></em>
                                                            </span>
                                                             <span id="calculationCheckIcon"><label class="check"></label></span>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div>
                                                <table class="w_auto">
                                                <tr>
                                                    <td class="withinput" style="width:115px;"><b>Calculation </b></td>
                                                    <td class="padding-l20px"><input type="text" id="calculation" name="calculation" class="width-140px"/></td>
                                                </tr>
                                                <tr>
                                                    <td class="withinput" style="width:115px;"><b><fmt:message key="aimir.description"/></b></font></td>
                                                    <td class="padding-l20px"><input type="text" id="calDescr" name="calDescr" class="width-140px"/></td>
                                                </tr>
                                                </table>
                                            </div>
                                        </div>
                            ...
                            <div id="infoBtnList">
                                <div id="btn" class="meter-info-btn2">
                                    <div style="display:block;" >
                                        <ul><li><a href="javaScript:confirmAdjustment();" class="on"><fmt:message key="aimir.button.confirm"/></a></li></ul>
                                        <ul><li><a href="javaScript:resetCalculationInfo();" class="on"><fmt:message key="aimir.cancel"/></a></li></ul>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="bodyright_meterinfo" style="height : 0">
                        	<ul>
                        		<li id="meterInstallDiv" class="bodyright_meterinfo_leftmargin" >
                   				<div class="headspace"><span><label class="check"><fmt:message key='aimir.contract'/> <fmt:message key="aimir.info"/></label></div>
                        		<div class="box-bluegradation-meter">
									<div class="padding20px">
		                        		...
		                        		<table class="wfree">
											<tr>	
												<th class="withinput" width="200px"><b><fmt:message key="aimir.customername"/></b></th>
												<td><span><input id="adjustment_customerName" type="text" readonly></span></td>
											</tr>
											<tr>	
												<th class="withinput" width="200px"><b><fmt:message key="aimir.buildingMgmt.contractNumber"/></b></th>
												<td><span><input id="adjustment_contractNumber" type="text" readonly></span></td>
											</tr>
											<tr>	
												<th class="withinput" width="200px"><b><fmt:message key="aimir.credit"/></b></th>
												<td><span><input id="adjustment_currentCredit" type="text" readonly></span></td>
											</tr>
											<tr>	
											<th class="withinput" width="200px"><b><fmt:message key="aimir.arrears"/></b></th>
												<td><span><input id="adjustment_currentArrears" type="text" readonly></span></td>
											</tr>
										</table>
										</div>
									</div>
			...
			<!-- Traceable 내역 조회 -->
			<div class="padding20px">
	            <form id="traceableHistoryForm" class="searchoption-container">
					<div class="wrapper">
	            		<label class="check">Traceable History</label>
	            	</div>
	            	<div class="wrapper">
	            		<input name="traceable_contractNumber" class="hidden" type="text"></input>
	            	    <span>
	                        <label><fmt:message key="aimir.searchDate"/></label>
	                        <input class="alt startDate" name="startDateDisplay" type='text' readOnly/>
	                        <input name="startDate" class="no-width" type="text"/>
                    	...
                    	<span id="traceableHistorySearch" class="am_button margin-l10 margin-t1px">
                       		<a class="on"><fmt:message key="aimir.button.search"/></a>
                    	</span>
                    </div>
					</form>
					<div id="traceableHistoryDiv"></div>
			 </div> 
			</div>
    	</div>
    </div>
    <script type="text/javascript" charset="utf-8">/*<![CDATA[*/
        ...
        var extJsTitle = '<fmt:message key="aimir.header.msg" />';
        var remitterCredit = 0;
        var isContractCheck = false;
        var isAmountCheck = false;
        var isCalculationCheck = false;
        ...
        var isHiddenCancelBtnTF = function(){
	        var isHiddenCancelBtn = true;
            if (vendorRole == 'admin' || vendorRole == 'oak_admin'){
                isHiddenCancelBtn = false;
            }else{
                isHiddenCancelBtn = true;
            }
            return isHiddenCancelBtn;
        }; 
        ...
        var balanceManagerGrid;
        var traceableHistoryGrid;
        ...
        var balanceManagerParams = $.extend(true, {supplierId: supplierId}, storeParams);

        var traceableHistoryParams = $.extend(true, {
        	contractNumber: null,
            // 0000년 00월 00일 ~ 9999년 99월 99일까지, 즉 전체 기간
            startDate: '00000000',
            endDate: '99999999'
        ...
        var historyListStore = new Ext.data.JsonStore({
            ...
            fields: ["lastTokenDate", "chargedCredit", "chargedArrears", "balance", "arrears",
                "lastTokenId", "authCode", "municipalityCode", "cancelCredit", "cancelReason"],
            listeners: {
                beforeload: function(store, options) {
                    var params = options.params;
                    if (params.start && params.start > 0) {
        ...
        var balanceManagerStore = new Ext.data.JsonStore({
            baseParams: balanceManagerParams,
            url: "${ctx}/gadget/prepaymentMgmt/getPrepaymentChargeList.do",
            totalProperty: 'totalCount',
            root: 'result',
            fields: ['contractNumber', 'customerNo', 'customerName', 'mdsId',
                'address', 'lastTokenDate', 'currentCredit', 'currentArrears',
                'barcode', 'chargeAvailable', 'statusName'],
            listeners: {
                beforeload: function(store, options) {
                    var params = options.params;
        ...
        var traceableHistoryStore = new Ext.data.JsonStore({
            baseParams: traceableHistoryParams,
            url: "${ctx}/gadget/prepaymentMgmt/getTraceableHistoryList.do",
            totalProperty: 'totalCount',
            root: 'result',
            fields: ['contractNumber', 'eventDate', 'target', 'jobType',
                'balanceBefore', 'balanceAfter', 'amount', 'descr'
                ],
            listeners: {
                beforeload: function(store, options) {
                    var params = options.params;
        ...
        var historyListModel = new Ext.grid.ColumnModel({
            columns: [
                ...
                {header: "<fmt:message key='aimir.prepayment.chargearrears'/>", align: 'right', dataIndex:'chargedArrears'}, 
                {header: "<fmt:message key='aimir.credit'/>", align: 'right', dataIndex:'balance'},
                {header: "<fmt:message key='aimir.prepayment.cancelamount'/>", align: 'right', dataIndex: 'cancelCredit'},
                {header: "<fmt:message key='aimir.arrears'/>", align: 'right', dataIndex: 'arrears'},
                {header: "<fmt:message key='aimir.hems.prepayment.transactionNum'/>", align: 'right', dataIndex: 'lastTokenId'}, 
                {header: "<fmt:message key='aimir.prepayment.authCode'/>", align: 'right', dataIndex: 'authCode'},
                {header: "<fmt:message key='aimir.prepayment.municipalityCode'/>", align: 'right', dataIndex: 'municipalityCode'}, 
                {header: "<fmt:message key='aimir.description'/>", align: 'right', dataIndex: 'cancelReason'},
                {header: "", renderer: receiptBtnArea},
                {header: "", renderer: cancelBtnArea, hidden: isHiddenCancelBtnTF()},
        ...
        var balanceManagerModel = new Ext.grid.ColumnModel({
            columns: [
                {header: "<fmt:message key='aimir.contractNumber'/>", dataIndex: 'contractNumber'}
               ,{header: "<fmt:message key='aimir.customerid'/>", dataIndex: 'customerNo'}
               ,{header: "<fmt:message key='aimir.customername'/>", dataIndex: 'customerName'}
               ...
               ,{header: "<fmt:message key='aimir.credit'/>", dataIndex: 'currentCredit',  align: 'right'}
               ,{header: "<fmt:message key='aimir.arrears'/>", dataIndex: 'currentArrears', align: 'right'}
               ,{header: "<fmt:message key='aimir.barcode'/>", dataIndex: 'barcode', align: 'right'}
            ],
            defaults: {
                sortable: true
               ,menuDisabled: true
        ...
        var traceableHistoryModel = new Ext.grid.ColumnModel({
            columns: [
                {header: "<fmt:message key='aimir.contractNumber'/>", dataIndex: 'contractNumber'}
               ,{header: "<fmt:message key='aimir.event'/>"+" "+"<fmt:message key='aimir.time.date'/>", dataIndex: 'eventDate'}
               ,{header: "<fmt:message key='aimir.target'/> Number", dataIndex: 'target'}
               ,{header: "Job Type", dataIndex: 'jobType'}
               ,{header: "Balance Before", dataIndex: 'balanceBefore'}
               ,{header: "Balance After", dataIndex: 'balanceAfter'}
               ,{header: "<fmt:message key='aimir.deposit.chargecredit'/>", dataIndex: 'amount'}
               ,{header: "<fmt:message key='aimir.description'/>", dataIndex: 'descr'}
            ],
            defaults: {
                sortable: true
               ,menuDisabled: true
        ...
        var balanceManagerSm = new Ext.grid.RowSelectionModel($.extend(true, {}, sm));
        ...
        var balanceManagerBbar = new Ext.PagingToolbar($.extend(
            true,
            {},
            {store: balanceManagerStore, pageSize: PAGE_SIZE},
            bbar));

        var traceableHistoryBbar = new Ext.PagingToolbar($.extend(
            true,
            {},
            {store: traceableHistoryStore, pageSize: PAGE_SIZE},
            bbar));
        ...
        var balanceManagerProp = $.extend(true, {}, gridProp, {
            height: 235,
            colModel: balanceManagerModel,
            sm: balanceManagerSm,
            bbar: balanceManagerBbar,
            store: balanceManagerStore,
            renderTo: 'balanceManagerDiv'
        });

        var traceableHistoryProp = $.extend(true, {}, gridProp, {
            height: 235,
            colModel: traceableHistoryModel,
            //sm: traceableHistorySm,
            bbar: traceableHistoryBbar,
            store: traceableHistoryStore,
            renderTo: 'traceableHistoryDiv'
        });
        ...
        var eventHandler = {
            ...
            selectedBalanceManagerSearch: function(sm, rowIndex, rec) {
            	resetTransferInfo();
            	resetCalculationInfo();
            	
                var contractNumber = rec.json.contractNumber;
                var customerName = rec.json.customerName;
                var currentCredit = rec.json.currentCredit;
                
                var currentArrears = rec.json.currentArrears;
                var params = $.extend(true, {}, balanceManagerParams, {
                    contractNumber: contractNumber
                });
                
	            $('#remitter_contractNumber').val(contractNumber);
	            $('#remitter_customerName').val(customerName);
	            $('#remitter_currentCredit').val(currentCredit);
	            $('#remitter_currentArrears').val(currentArrears);
				
	            $('#adjustment_contractNumber').val(contractNumber);
	            $('#adjustment_customerName').val(customerName);
	            $('#adjustment_currentCredit').val(currentCredit);
	            $('#adjustment_currentArrears').val(currentArrears);

	            var params_traceable = $.extend(true, {}, traceableHistoryParams, {
                    contractNumber: contractNumber,
                    supplierId: supplierId
                });
	            
	            $("#traceableHistoryForm input[name=traceable_contractNumber]").val(contractNumber);
	            traceableHistoryStore.baseParams = params_traceable;
                traceableHistoryStore.load({
                    params: params_traceable
                }); 
	            
	            balanceManagerStore.baseParams = params;
            },
            ...
            balanceContractListSearch: function(callback) {
                var params = $.extend(true, {}, balanceManagerParams, {
                    barcode: $("#balance_barcodeNumber").val(),
                    contractNumber: $("#balance_contractNumber").val(),
                    customerNo: $("#balance_customerNo").val(),
                    customerName: $("#balance_customerName").val(),
                    mdsId: $("#balance_mdsId").val()
                });
                
                balanceManagerStore.baseParams = params;
                balanceManagerStore.load({
                    params: params,
                    callback: callback
                });
            },
            ...
            traceableHistorySearch: function() {
                var params = $.extend(true, {}, traceableHistoryParams, {
                	 supplierId: supplierId,
                	 contractNumber: $("#traceableHistoryForm input[name=traceable_contractNumber]").val(),
                	 startDate: $("#traceableHistoryForm input[name=startDate]").val() || '00000000',
                     endDate: $("#traceableHistoryForm input[name=endDate]").val() || '99999999'
                });
				
                traceableHistoryStore.baseParams = params;
                traceableHistoryStore.load();
            },
            ...
            initBalanceManagerTab: function() {
                balanceManagerStore.reload();
            },
            ...
            logIn: function() {
                ...
                var logOn = function(json) {
                    ...
                    $("#menu").show();
                    $("#loginWrapper").hide();
                    $('#contractCheckIcon').hide();
                    $('#transferAmountCheckIcon').hide();
                    $('#calculationCheckIcon').hide();
                    ...
                    if (isFirstLogIn) {
                        ...
                        $("#menu li.balanceManagerTab").hide();
                    }
        ...
        var bind = function() {
            ...
            $("#balanceManagerForm span#balance_contractSearch").click(eventHandler.balanceContractListSearch);
            ...
            $('#traceableHistoryForm span#traceableHistorySearch').click(eventHandler.traceableHistorySearch);

            contractListSm.addListener('rowselect', eventHandler.selectedHistorySearch);
            balanceManagerSm.addListener('rowselect', eventHandler.selectedBalanceManagerSearch);   
            ...
            $('a[href=#balanceManagerTab]').bind('click', eventHandler.initBalanceManagerTab);
        ...
        var renderGrid = function() {
            ...
            balanceManagerGrid = new Ext.grid.EditorGridPanel(balanceManagerProp);
            traceableHistoryGrid = new Ext.grid.EditorGridPanel(traceableHistoryProp);
            ...
            traceableHistoryStore.load({params: traceableHistoryParams});
        };
        ...
        var initCalendar = function() {
            ...
            var trStartProp = $.extend(true, calendarProp);
            var trEndProp = $.extend(true, calendarProp);
            ...
            $('#traceableHistoryForm input[name=startDate]').datepicker(trStartProp);
            $('#traceableHistoryForm input[name=endDate]').datepicker(trEndProp);
            ...
            $('#traceableHistoryForm input[name=startDate]').datepicker('setDate', startDate);
            $('#traceableHistoryForm input[name=endDate]').datepicker('setDate', endDate);
        ...
        $(window).resize(function() {
          ...
          balanceManagerGrid.getView().refresh();
          traceableHistoryGrid.getView().refresh();
        });
        ...
        // 로그인 아이디가 admin일때 Balance Manage 탭을 수정할 수 없도록 한다
        function hideTab(){
        	var casherId = $("#loginWrapper input[name=loginId]").val();
        	if(casherId=='admin'){
        		$('#balnceAdjustmentTab').hide();
        	}
        }
        
        function checkContract() {
            var trimContractNu = $.trim($('#contractNu').val());
            var remitterContractNum = $('#remitter_contractNumber').val();
            var dataIndex = 0;
            
            $('#contractNu').val(trimContractNu);
            if ($('#contractNu').val() == null || $('#contractNu').val() == "") {
                resetRemitteeInfo();
                isContractCheck = false;
                $('#contractCheckIcon').hide();
                Ext.Msg.alert(extJsTitle,"Please enter the contract number for transfer.", null, null);
            } else if(trimContractNu == remitterContractNum){
            	isContractCheck = false;
                $('#contractCheckIcon').hide();
            	Ext.Msg.alert(extJsTitle,"Select other contract (Remitter and Remittee can't be same).", null, null);
            } else {
                    $.getJSON('${ctx}/gadget/prepaymentMgmt/getPrepaymentChargeList.do', {
                    'supplierId' : supplierId,
                    'page' : 1,
                    'limit' : PAGE_SIZE,
                    'contractNumber' : $('#contractNu').val(),
                    'taskType' : "remittance"
                }, function(returnData) {
                    if (returnData.totalCount == 0) {
                        ...
                        isContractCheck = false;
                        $('#contractCheckIcon').hide();
                        Ext.Msg.alert(extJsTitle, "<fmt:message key='aimir.cannot.use'/>", null, null);
                    } else if (returnData.totalCount > 1) {
                        resetRemitteeInfo();
                        isContractCheck = false;
                        $('#contractCheckIcon').hide();
                        Ext.Msg.alert(extJsTitle, $('#contractNu').val()
                                + " There are two identical contract numbers in the database. So this contract number is not available. Please contact your administrator.", null, null);
                    } else {
                        isContractCheck = true;
                        $('#contractCheckIcon').show();
                        Ext.Msg.alert(extJsTitle, $('#contractNu').val() + " <fmt:message key='aimir.abailableId'/>", null, null);
                        
                        var contractNumber = returnData.result[dataIndex].contractNumber;
                        var customerName = returnData.result[dataIndex].customerName;
                        var currentCredit = returnData.result[dataIndex].currentCredit;
                        var currentArrears = returnData.result[dataIndex].currentArrears;
                        
                        $('#recipient_contractNumber').val(contractNumber);
                        $('#recipient_customerName').val(customerName);
                        $('#recipient_currentCredit').val(currentCredit);
                        $('#recipient_currentArrears').val(currentArrears);
        ...
        function checkTransferAmount() {
            ...
            var remitterCurrentArrears = $('#remitter_currentArrears').val();
            var remitterCreditBefore = $('#remitter_currentCredit').val();
            var contractNu = $('#contractNu').val();
            var remitterContractNum = $('#remitter_contractNumber').val();
            var splitList = '';
            var remitterCredit = '';
            splitList = remitterCreditBefore.split(',');
            for(var i=0; i<splitList.length; i++){
            	remitterCredit += splitList[i];
            }
            if (!isContractCheck) {
                isAmountCheck = false;
                $('#transferAmountCheckIcon').hide();
                Ext.Msg.alert(extJsTitle,"You need to verify remitter's contract first.", null, null);
            } else if(contractNu == remitterContractNum){
            	isAmountCheck = false;
                $('#transferAmountCheckIcon').hide();
            	Ext.Msg.alert(extJsTitle,"Select other contract (Remitter and Remittee can't be same).", null, null);
                ...
                isAmountCheck = false;
                $('#transferAmountCheckIcon').hide();
                Ext.Msg.alert(extJsTitle,"Please enter the transfer amounts.", null, null);
            } else if ($('#remitter_contractNumber').val() == null || $('#remitter_contractNumber').val() == "") {
                isAmountCheck = false;
                $('#transferAmountCheckIcon').hide();
                Ext.Msg.alert(extJsTitle,"Please choose the remitter account.", null, null);
            } else if(transferAmount <= 0) {
                isAmountCheck = false;
                $('#transferAmountCheckIcon').hide();
                Ext.Msg.alert(extJsTitle,"You cannot transfer this amount.", null, null);
            } else if(isNaN(transferAmount)) {
                isAmountCheck = false;
                $('#transferAmountCheckIcon').hide();
                Ext.Msg.alert(extJsTitle,"Please enter a number.", null, null);
           } else if (remitterCurrentArrears > 0) {
                isAmountCheck = false;
                $('#transferAmountCheckIcon').hide();
                Ext.Msg.alert(extJsTitle,"The remitter has arrears.", null, null);             
           } else {
                if (remitterCredit - transferAmount >= 0) {
                    isAmountCheck = true;
                    Ext.Msg.alert(extJsTitle,"You can transfer this amount.", null, null);
                    $('#transferAmountCheckIcon').show();
                } else {
                    isAmountCheck = false;
                    $('#transferAmountCheckIcon').hide();
                    Ext.Msg.alert(extJsTitle,"You cannot remit more than the balance of the remitter account.", null, null);
                }
            }
        }
        ...
        function confirmTransfer() {
            if(!isContractCheck){
                ...
                Ext.Msg.alert(extJsTitle,"You need to verify the transfer amounts first.", null, null);
            } else {
                var params = {
                    supplierId: supplierId,
                    casherId: $("#loginWrapper input[name=loginId]").val(),
                    remitter_contractNumber: $('#remitter_contractNumber').val(),
                    remittee_contractNumber: $('#contractNu').val(),
                    transferAmount: $('#transferAmount').val(),
                    descr: $('#descr').val()
                };

                var transfer = function() {
                    $.post("${ctx}/gadget/prepaymentMgmt/balanceTransferSPASA.do",
                      params, function(data) {
                        if (data.result == 'success') {
                            // data.remitter_credit, data.remittee_credit
                            Ext.Msg.alert("<fmt:message key='aimir.message'/>", "<fmt:message key='aimir.success'/>");
                            
                            eventHandler.balanceContractListSearch();
                            resetTransferInfo();
                        } else {
                            Ext.Msg.alert("<fmt:message key='aimir.error'/>", data.result);
                        }
                ...
                Ext.Msg.confirm("<fmt:message key="aimir.message"/>",
                    "Do you want to transfer?", function(btn) {
                    if (btn == 'yes') {
                    transfer();
                    //traceableHistoryTransfer($('#remitter_contractNumber').val(),$('#contractNu').val(),$('#transferAmount').val(),$('#descr').val());
                    }
                });
            }
        }
        
        function resetTransferInfo() {
            isContractCheck = false;
            isAmountCheck = false;
            
            $('#contractNu').val(null);
            $('#transferAmount').val(null);
            $('#descr').val(null);
            
            $('#remitter_contractNumber').val(null);
            $('#remitter_customerName').val(null);
            $('#remitter_currentCredit').val(null);
            $('#remitter_currentArrears').val(null);
            
            $('#recipient_contractNumber').val(null);
            $('#recipient_customerName').val(null);
            $('#recipient_currentCredit').val(null);
            $('#recipient_currentArrears').val(null);
            
            $('#transferAmountCheckIcon').hide();
            $('#contractCheckIcon').hide();
        }
        
        function resetRemitteeInfo() {
            $('#recipient_contractNumber').val(null);
            $('#recipient_customerName').val(null);
            $('#recipient_currentCredit').val(null);
            $('#recipient_currentArrears').val(null);
        ...
        function countCalculation(){
            var balanceSplitBefore = $('#adjustment_currentCredit').val();
            var balanceAfter = $.trim($('#setBalance').val());
            $('#setBalance').val(balanceAfter);
            var splitList = '';
            var balanceBefore = '';
            splitList = balanceSplitBefore.split(',');
            for(var i=0; i<splitList.length; i++){
            	balanceBefore += splitList[i];
            }
            
            if(balanceSplitBefore==null){
               isCalculationCheck = false;
               $('#calculationCheckIcon').hide();
               Ext.Msg.alert(extJsTitle,"Please select the contract.", null, null);
            } else if ($('#setBalance').val() == null || $('#setBalance').val() == "") {
                isCalculationCheck = false;
                $('#calculationCheckIcon').hide();
                Ext.Msg.alert(extJsTitle,"Please enter the new balance to set.", null, null);
             } else if (isNaN(balanceAfter)){
            	 isCalculationCheck = false;
                 $('#calculationCheckIcon').hide();
                 Ext.Msg.alert(extJsTitle,"Please enter a number.", null, null);
             } else{
            	 isCalculationCheck = true;
                 $.getJSON('${ctx}/gadget/prepaymentMgmt/getNewBalance.do', {
                    'supplierId' : supplierId,
                    'page' : 1,
                    'limit' : PAGE_SIZE,
                	...
                	if(returnData.operator=='-')
                		$('#calculation').val("Credit "+returnData.resultValue);
                	else
                		$('#calculation').val("Credit "+returnData.operator+returnData.resultValue);
                	 $('#calculationCheckIcon').show();
                }); 
            }
        }
        ...
        function confirmAdjustment(){
        	 var balanceSplitBefore = $('#adjustment_currentCredit').val();
        	 var balanceAfter = $('#setBalance').val();
        	 var splitList = '';
             var balanceBefore = '';
             splitList = balanceSplitBefore.split(',');
             for(var i=0; i<splitList.length; i++){
        	...
        	if(!isCalculationCheck){
        		Ext.Msg.alert(extJsTitle,"You need to verify balance adjustment first.", null, null);
        	} else{
        		 var params = {
                         supplierId: supplierId,
                         casherId: $("#loginWrapper input[name=loginId]").val(),
                         adjustment_contractNumber: $('#adjustment_contractNumber').val(),
                         balanceBefore: balanceBefore,
                         balanceAfter: balanceAfter,
                         descr: $('#calDescr').val()
                     };
        		 var transfer = function() {
                     $.post("${ctx}/gadget/prepaymentMgmt/balanceAdjustmentSPASA.do",
                       params, function(data) {
                         if (data.result == 'success') {
                             Ext.Msg.alert("<fmt:message key='aimir.message'/>", "<fmt:message key='aimir.success'/>"+ " "+
                            		 					"\n(Balance Before : " +balanceBefore + ", " +
                            		 					"Balance After : " + data.balanceAfter +")");
                 ...
                 Ext.Msg.confirm("<fmt:message key="aimir.message"/>",
                     "Do you want to set new balance?", function(btn) {
                     if (btn == 'yes') {
	                     transfer();
                     }
                 });
        ...
        function resetCalculationInfo(){
        	isCalculationCheck = false;
            $('#setBalance').val(null); 
            $('#calculation').val(null); 
            $('#calDescr').val(null); 
            $('#adjustment_contractNumber').val(null);
            $('#adjustment_customerName').val(null);
            $('#adjustment_currentCredit').val(null);
            $('#adjustment_currentArrears').val(null);
            $('#calculationCheckIcon').hide();
        }
