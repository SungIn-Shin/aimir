...
<body>
  ...
  var dailyListStore = new Ext.data.JsonStore({
    ...
    'balance', 'arrears', 'vendorName', 'cashierName', 'cancelCredit', 'cancelReason'],
  ...
  var monthlyListStore = new Ext.data.JsonStore({
    ...
    'chargedArrears','vendorName', 'cashierName', 'cancelCredit'],
    listeners: {
      beforeload: function(store, options) {
        var params = options.params;
        if (params.start && params.start > 0) {
  ...
  var dailyListModel = new Ext.grid.ColumnModel({
    columns: [
      ...
      {header: "<fmt:message key='aimir.prepayment.authCode'/>", dataIndex: 'authCode', align: 'right'},
      {header: "<fmt:message key='aimir.deposit.chargecredit'/>", dataIndex: 'chargedCredit', align: 'right'},
      {header: "<fmt:message key='aimir.prepayment.cancelcredit'/>", dataIndex: 'cancelCredit', align: 'right'},
      {header: "<fmt:message key='aimir.prepayment.chargearrears'/>", dataIndex: 'chargedArrears', align: 'right'},
      {header: "<fmt:message key='aimir.credit'/>", dataIndex: 'balance', align: 'right'},
      {header: "<fmt:message key='aimir.arrears'/>", dataIndex: 'arrears', align: 'right'},
      {header: "<fmt:message key='aimir.prepayment.cancelreason'/>", dataIndex: 'cancelReason', align: 'right'}
	],
defaults: {
      sortable: true,
      menuDisable: true
  ...
  var monthlyListModel = new Ext.grid.ColumnModel({
    columns: [
      ...
      {header: "<fmt:message key='aimir.meterid'/>", dataIndex: 'mdsId'},
      {header: "<fmt:message key='aimir.vendor'/>", dataIndex: 'vendorName'},
      {header: "<fmt:message key='aimir.prepayment.municipalityCode'/>", dataIndex: 'municCode'},
      {header: "<fmt:message key='aimir.time.from'/> <fmt:message key='aimir.time.date'/>", dataIndex: 'startDate'},
      {header: "<fmt:message key='aimir.open'/> <fmt:message key='aimir.balance'/>", dataIndex: 'startBalance', align: 'right'},
      {header: "<fmt:message key='aimir.time.to'/> <fmt:message key='aimir.time.date'/>", dataIndex: 'endDate'},
      {header: "<fmt:message key='aimir.board.close'/> <fmt:message key='aimir.balance'/>", dataIndex: 'endBalance', align: 'right'},
      {header: "<fmt:message key='aimir.usage'/>", dataIndex: 'usedEnergy',align: 'right'},
      {header: "<fmt:message key='aimir.used.cost'/>", dataIndex: 'usedCost', align: 'right'},
      {header: "<fmt:message key='aimir.deposit.chargecredit'/>", dataIndex: 'chargedCredit', align: 'right'},
      {header: "<fmt:message key='aimir.prepayment.chargearrears'/>", dataIndex: 'chargedArrears', align: 'right'},
      {header: "<fmt:message key='aimir.prepayment.cancelamount'/>", dataIndex: 'cancelCredit', align: 'right'}
    ],
    defaults: {
      sortable: true,
      menuDisable: true
