        ...
        geocoder.geocode( { 'address': locationName}, function(results, status) {
        	...
        	if(status == google.maps.GeocoderStatus.OK) {
        		...
        		map = new google.maps.Map(mapDiv, {
	    			...
	    			//center: new google.maps.LatLng(14.5, 100),// for thailand
	    			//center: new google.maps.LatLng(-29, 25),
	    			//center: new google.maps.LatLng(-26, 28),
	    			zoom: 7,
	    			mapTypeId: google.maps.MapTypeId.ROADMAP
	    		});
        	}
...
*/
	 ...
	 RadiusWidget.prototype.distance_changed = function() {   this.set('radius', this.get('distance') * 1000); };
	*/
