                ...
                for ( var i = 0; i < json.namesOfContain.length; i++) {
                    switch (json.namesOfContain[i]) {
                        ...
                        case 'TracerouteControl':
                            ...
                            break;
                        case 'LimitPowerUsage':
                            if(editAuth == "true")
                                $('#limitPowerUsageButton').show();
							break;
                        case 'OTA':
                            if(editAuth == "true")
                                $('#otaButton').show();
...
//     }
    ...
    function onDemand() {
        ...
        var resolution = document.getElementById("esolution_container").children[0].getElementsByClassName("selected")[0].id.replace(/[^0-9]/g,''); // Regex : Not Include 0~9 , Global => Remove
...
*/
	...
	function popupOBIS() {
		...
		var opts = "width=670px, height=600px, left=" + left
								...
								<div id="meterCommand" style="padding-top: 20px;">
									...
									<div class="headspace floatleft">
										...
										<div id="onDemandButton" class="floatleft margin-r5"
											style="display: block">
											<div class="floatleft">
												<em class="btn_org"> <a href="#this"
													onClick="showOnDemand();"> <fmt:message
															key="aimir.onDemand.Metering" />
												</a>
												</em> <em class="btn_org"><a href="javascript:popupOBIS();"><fmt:message
															key="aimir.obis" /></a></em> <em class="btn_org"><a
													href="javascript:commandPing();"><fmt:message
															key="aimir.ping" /></a></em> <em class="btn_org"><a
													href="javascript:commandTraceroute();"><fmt:message
															key="aimir.traceroute" /></a></em>
												<!-- <em class="btn_org"><a href="javascript:realTimeMeteringTest()">RealTimeMetering Test</a></em> -->
											</div>

											<div id="selectDate" class="floatleft tootipbox"
												style="display: none;">
												<div id="selectDateForDcu"
													style="display: inline-block; float: left;">
													<span style="margin: 2px; padding: 0px;"> <input
														type="radio" name="chk_info" value="MCU">DCU
													</span>
												</div>

												<span style="margin: 2px; padding: 0px;"> <input
													type="radio" name="chk_info" value="MODEM">MODEM
												</span> <span style="margin: 2px; padding: 0px;"> <input
													type="radio" name="chk_info" value="METER">METER
												</span> <span style="margin: 0px; padding: 0px;">
													<button id="onDemandFromDateLeft" type="button"
														class="back"></button>
												</span> <span style="margin: 0px; padding: 0px;"> <input
													id="onDemandFromDate" type="text" readonly="readonly"
													class="day" /> <input id="onDemandFromDateHidden"
													type="hidden" />
												</span> <span style="margin: 0px; padding: 0px;">
													<button id="onDemandFromDateRight" type="button"
														class="next"></button>
												</span> <span
													...
													id="onDemandToDate" type="text" readonly="readonly"
													class="day" /> <input id="onDemandToDateHidden"
													type="hidden" />
												</span> <span style="margin: 0px; padding: 0px;">
													<button id="onDemandToDateRight" type="button" class="next"></button>
												</span> <em class="am_button margin-t2px"> <a
													href="javascript:onDemand();"><fmt:message
															key="aimir.button.confirm" /></a>
												</em>&nbsp; <em class="am_button margin-t2px"> <a
													href="#this"
													onClick="javascript:clearAndHideOnDemandButton();"><fmt:message
															key="aimir.cancel" /></a>
												</em>
											</div>
										</div>
										...
										<div id="restoreDefaultFirmwareButton"
											class="floatleft margin-r5" style="display: none;">
											<em class="btn_org"><a
												href="javascript:cmdRestoreDefaultFW();">Restore Default
													Firmware</a></em>
										</div>
										...
										<div id="valveControlButton" class="floatleft margin-r5"
											...
											<em class="btn_org"><a
												...
												class="btn_org"><a
												href="javascript:cmdRelayActivate();">Valve Standby</a></em> <em
												class="btn_org"><a href="javascript:cmdRelayOff();">Valve
													Off</a></em> <em class="btn_org"><a
												href="javascript:cmdRelayOn();">Valve On</a></em>
										</div>
										<div id="relayActivateButton" class="floatleft margin-r5"
											style="display: none">
											<em class="btn_org"><a
												href="javascript:cmdRelayActivate();">Relay Activate</a></em>
										</div>
										<div id="cmdRelayStatusButton" class="floatleft margin-r5"
											style="display: none">
											<em class="btn_org"><a
												href="javascript:cmdRelayStatus();">Relay Status</a></em>
										</div>
										<div id="cmdRelayOffButton" class="floatleft margin-r5"
											style="display: none">
											<em class="btn_org"><a
												href="javascript:CaptchaPanel('off');">Relay Off</a></em>
										</div>
										<div id="cmdRelayOnButton" class="floatleft margin-r5"
											style="display: none">
											<em class="btn_org"><a
												href="javascript:CaptchaPanel('on');">Relay On</a></em>
										</div>
										...
										<div id="limitPowerUsageButton" class="floatleft margin-r5">
											<em class="btn_org"><a
												href="javascript:CaptchaPanel('limitPowerUsage');"><fmt:message
														key="aimir.limitPowerUsage" /></a></em>
										</div>
										<div id="otaButton" class="floatleft margin-r5">
											<em class="btn_org"><a href="javascript:runOta();"><fmt:message
														key="aimir.ota" /></a></em>
										</div>
										<div id="fwVersionButton" class="floatleft margin-r5">
											<em class="btn_org"><a
												href="javascript:commandGetMeterFWVersion();">F/W
													Version</a></em>
										</div>
										<div id="coapPingButton" class="floatleft margin-r5"
											style="display: none">
											<em class="btn_org"><a
												href="javascript:commandCOAPPing();"><fmt:message
														key="aimir.coapPing" /></a></em>
										</div>
										...
										<div id="btnDisplayItemSetting" class="floatleft margin-r5"
											style="display: none">
											<em class="btn_org"><a
												href="javascript:cmdDisplayItemSetting();">Display Item
													Setting</a></em>
										</div>
										<div id="summerTime" class="floatleft margin-r5"
											style="display: none">
											<em class="btn_org"><a
												href="javascript:cmdSummerTime();">Summer Time</a></em>
										</div>
