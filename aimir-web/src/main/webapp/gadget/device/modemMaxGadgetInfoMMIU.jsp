    ...
    <div id="modemInfoEdit" style="display:block;">
	   <form id="modemInfoForm">
	            <table class="wfree" id="tableEdit">
		            ...
		            <tr>
						<th>IPv4 Address</th>
	                    <td colspan="4"><input style="width: 464px !important;" type="text" id="ipAddr" name="ipAddr" value="<c:catch>${modem.ipAddr}</c:catch>" /></td>
		            </tr>
		            <tr>
     ...
     <div id="modemInfoView" style="display:none;">
       <form id="modemInfoForm">
                <table class="wfree" id="tableView">
	            	...
	            	<tr>
						<th>IPv4 Address</th>
	                    <td colspan="4"><input style="width: 464px !important;" type="text" class="border-trans" readonly="readonly" value="${modem.ipAddr}" /></td>
	                </tr>
	                <tr>
						<th><fmt:message key='aimir.ipv6address'/></th>
