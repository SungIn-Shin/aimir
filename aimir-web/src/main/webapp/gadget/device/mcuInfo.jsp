    ...
    <li class="padding">
                                            ...
                                            <td colspan="2">
                                                <c:choose>
                                                    <c:when test="${not empty mcu.mcuCodi.codiID}">
                                                           <input type="text" value="${mcu.mcuCodi.codiID}" class="border-trans gray11pt"  readonly/>
                                                    </c:when>
                                                    <c:otherwise>
                                                           <input type="text" value="-" class="border-trans gray11pt"  readonly/>
                                                    </c:otherwise>
        ...
        <div id="mcu-tab-wide" class="width_auto margin-t60px">
            ...
            <div class="width_auto">
                ...
                <br /><br />
                <%-- <em class="btn_org"><a href="javascript:mcuStatusMonitoring();"><fmt:message key="aimir.mcu.statusmonitoring"/></a></em> --%>
            ...
            <div class="meterinfo-textarea margin-t5px">
