...
public class DepositHistoryDataMakeExcel {
	Log logger = LogFactory.getLog(DepositHistoryDataMakeExcel.class);
	...
	@SuppressWarnings("unchecked")
	public void writeDepositReportExcel(
...
//			parch.createPicture(anchor, loadPicture(request.getSession().getServletContext().getRealPath(logoImg), workbook));
			...
			// Image & INFO Section (S)
//			String dateFrom = TimeLocaleUtil.getLocaleDate(startDate, lang, country);
//			String dateTo = TimeLocaleUtil.getLocaleDate(endDate, lang, country);
//			String today = TimeLocaleUtil.getLocaleDate(currTime, lang, country);
//			
//            //printTitle(workbook, sheet, reportType, dateFrom, dateTo, today, false, StringUtil.nullToBlank(supplierDesc));
//			
//			String reportTitle = "Operator Sales Report";
//			int start = 11;			// 우측의 타이틀 및 날짜 row merge시  좌측좌표 
//			int end = SALES_WIDTH;	// 우측의 타이틀 및 날짜 row merge시  우측좌표
//			
...
//			sheet.addMergedRegion(new CellRangeAddress(6, 6, start, end -1));
			...
			cell.setCellValue(msgMap.get("msg_vendor").toString());
	        cell.setCellStyle(headerStyle);

	        cell = row.createCell(1);
	        //cell.setCellValue("Contract No.");
	        cell.setCellValue(msgMap.get("msg_contractNo").toString());
	        cell.setCellStyle(headerStyle);

	        cell = row.createCell(2);
	        //cell.setCellValue("Customer ID");
	        cell.setCellValue(msgMap.get("msg_customerId").toString());
	        cell.setCellStyle(headerStyle);

	        cell = row.createCell(3);
	        //cell.setCellValue("Meter ID");
	        cell.setCellValue(msgMap.get("msg_meterId").toString());
	        cell.setCellStyle(headerStyle);

	        cell = row.createCell(4);
	        //cell.setCellValue("Customer Name");
	        cell.setCellValue(msgMap.get("msg_customerName").toString());
	        cell.setCellStyle(headerStyle);

	        cell = row.createCell(5);
	        //cell.setCellValue("Address");
	        cell.setCellValue(msgMap.get("msg_address").toString());
	        cell.setCellStyle(headerStyle);
	        
	        cell = row.createCell(6);
	        //cell.setCellValue("Date");
	        cell.setCellValue(msgMap.get("msg_chargeDate").toString());
	        cell.setCellStyle(headerStyle);
	        
	        cell = row.createCell(7);
	        //cell.setCellValue("Charged Credit");
	        cell.setCellValue(msgMap.get("msg_chargeCredit").toString());
	        cell.setCellStyle(headerStyle);
	        
	        cell = row.createCell(8);
	        //cell.setCellValue("Net Value");
	        cell.setCellValue(msgMap.get("msg_netValue").toString());
	        cell.setCellStyle(headerStyle);
	        
	        cell = row.createCell(9);
	        //cell.setCellValue("Deposit");
	        cell.setCellValue(msgMap.get("msg_deposit").toString());
	        cell.setCellStyle(headerStyle);
	        // Title Section-2 (E) 
			...
			for (int i = 0; i < dataList.size(); i++) {
                ...
                // Vendor
                cell = row.createCell(0);
                cell.setCellValue((resultMap.get("vendor") != null) ? resultMap.get("vendor").toString() : "");
                ...
                // Date
                cell = row.createCell(6);
                cell.setCellValue((resultMap.get("address") != null) ? resultMap.get("changeDate").toString() : "");
                cell.setCellStyle(bodyStyle_W_L);
                
                // Charge Credit
                cell = row.createCell(7);
                cell.setCellValue((resultMap.get("chargeCredit") != null) ? df.format(StringUtil.nullToDoubleZero(Double.parseDouble(resultMap.get("chargeCredit").toString()))) : "");
                cell.setCellStyle(bodyStyle_W_L);
                
                // Net Value
                cell = row.createCell(8);
                cell.setCellValue((resultMap.get("netValue") != null) ? df.format(StringUtil.nullToDoubleZero(Double.parseDouble(resultMap.get("netValue").toString()))) : "");
                cell.setCellStyle(bodyStyle_W_L);
                
                // Deposit
                cell = row.createCell(9);
                cell.setCellValue((resultMap.get("deposit") != null) ? df.format(StringUtil.nullToDoubleZero(Double.parseDouble(resultMap.get("deposit").toString()))) : "");
                cell.setCellStyle(bodyStyle_W_L);
            }
			// Data Section (E)
	...
	private void printSalesColumnHeader(HSSFSheet sheet, HSSFCellStyle style, Language lang) {
		Properties prop = new Properties();
		if (lang.getName().equalsIgnoreCase(Locale.KOREAN.toString())) {
			try {
