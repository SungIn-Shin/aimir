...
//        return new ModelAndView("jsonView", model);
     ...
     * @return
     */
    @RequestMapping(value="/gadget/system/supplier/getTariffTypeByServiceId.do")
    public ModelAndView getTariffTypeByServiceId(Integer serviceTypeId, Integer supplierId) {
    	
    	Code code = codeManager.getCode(serviceTypeId);
    	
		ModelAndView mav = getSTSTariffType(code.getCode(), supplierId);
	...
	@RequestMapping(value = "/gadget/system/supplier/getSTSTariff")
    public ModelAndView getSTSTariff(String tariffName, Integer tariffIndexId, String yyyymmdd) {
		ModelAndView mav = new ModelAndView("jsonView");
		
		List<Map<String,Object>> tariffInfo = tariffTypeManager.getSTSDlmsTariff(tariffIndexId,yyyymmdd);
		// List<Map<String,Object>> tariffInfo = tariffTypeManager.getSTSTariff(tariffIndexId,yyyymmdd);
		mav.addObject("tariffInfo", tariffInfo);
