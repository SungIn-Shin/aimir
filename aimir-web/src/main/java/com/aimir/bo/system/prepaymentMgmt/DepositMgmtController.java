...
public class DepositMgmtController {
    ...
    public ModelAndView depositMgmtMax() {
        ...
        if (supplier.getName().equals("ECG")) {
    ...
    public ModelAndView getHistory(
        ...
        if(subType != null) {
        	if (subType.equals("salesUnCancelled")) {
            	reportType = "sales";
    			subType = "unCancelled";
    		} else if (subType.equals("salesCancelled")) {
    			reportType = "sales";
    			subType = "cancelled";
    		}
        }
	...
	@RequestMapping(value = "/gadget/prepaymentMgmt/depositExcelDownloadPopup")
	public ModelAndView downloadDepositExcel() {
		ModelAndView mav = new ModelAndView("/gadget/prepaymentMgmt/depositExcelDownloadPopup");
		return mav;
	}
...
//	@RequestMapping(value="/gadget/prepaymentMgmt/depositSalesExcelMake")
//	public ModelAndView depositSalesExcelMake(
...
//		
//		// message pro. (S)
//		msgMap.put("msg_vendor", messageSource.getMessage("aimir.vendor", new Object[0], locale));
//		msgMap.put("msg_contractNo", messageSource.getMessage("aimir.buildingMgmt.contractNumber", new Object[0], locale));
//		msgMap.put("msg_customerId", messageSource.getMessage("aimir.customerid", new Object[0], locale));
//		msgMap.put("msg_meterId", messageSource.getMessage("aimir.meterid", new Object[0], locale));
//		msgMap.put("msg_customerName", messageSource.getMessage("aimir.customername", new Object[0], locale));
//		msgMap.put("msg_address", messageSource.getMessage("aimir.address", new Object[0], locale));
//		msgMap.put("msg_chargeDate", messageSource.getMessage("aimir.hems.prepayment.chargedate", new Object[0], locale));
//		msgMap.put("msg_chargeCredit", messageSource.getMessage("aimir.deposit.chargecredit", new Object[0], locale));
//		msgMap.put("msg_netValue", messageSource.getMessage("aimir.netvalue", new Object[0], locale));
//		msgMap.put("msg_deposit", messageSource.getMessage("aimir.deposit", new Object[0], locale));
//		// message pro. (E)
//
...
//		}
//
//		Map<String, Object> result = depositMgmtManager.getDepositHistoryList(condition);
//		List<Map<String, Object>> depositHistoryList = (List<Map<String, Object>>) result.get("list");
//		
...
//		
//		if (total <= maxRows) {
//			result.put("dataList", depositHistoryList);
//			splFileName = new StringBuilder(fileName);
//			splFileName.append(".xls");
//			excel.writeDepositReportExcel(result, msgMap, supplier, reportType, filePath, splFileName.toString(), StringUtil.nullToBlank(supplier.getDescr()), logoImg);
...
//					result.put("dataList", depositHistoryList.subList(idx, (i + 1)));
//					
//					excel.writeDepositReportExcel(result, msgMap, supplier, reportType, filePath, splFileName.toString(), StringUtil.nullToBlank(supplier.getDescr()), logoImg);
//					fileNameList.add(splFileName.toString());
//					splCnt = cnt;
