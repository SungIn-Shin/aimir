...
*/
    ...
    public ModelAndView getModemByType(@RequestParam("modemId") Integer modemId,
        ...
        else if (modemType.equals(ModemType.PLCIU.name()))
            mav = new ModelAndView("/gadget/device/modemMaxGadgetInfoPLCIU");
        else if (modemType.equals(ModemType.ZEUMBus.name()))
            mav = new ModelAndView("/gadget/device/modemMaxGadgetInfoZEUMBus");
        else if (modemType.equals(ModemType.ZBRepeater.name()))
            mav = new ModelAndView("/gadget/device/modemMaxGadgetInfoZBRepeater");
        else if (modemType.equals(ModemType.Converter.name()))
    ...
    public ModelAndView modemShipmentExcelMake(
        ...
        if (detailType.equals(CommonConstants.ShipmentTargetType.EthernetModem.getName())) {
        	...
        	detailType = ModemType.Converter.name(); 
	...
	@RequestMapping(value="/gadget/device/getDeviceList_modem2")
    public ModelAndView getDeviceList_dcu2(
    		@RequestParam(value="modelId") String modelId,
    		@RequestParam(value="versions") String versions,
    		@RequestParam(value="deviceId") String deviceId,
    		@RequestParam(value="fwVersion") String fwVersion,
		...
		List<String> deviceList = modemManager.getDeviceList2(condition);
	...
	@RequestMapping(value="/gadget/device/getTargetList_modem2")
    public ModelAndView getTargetListBy_modem2(
    		@RequestParam(value="modelId") String modelId,
    		@RequestParam(value="deviceId") String deviceId,
    		@RequestParam(value="fwVersion") String fwVersion,
    		@RequestParam(value="locationId") String locationId,
		...
		List<String> deviceList = modemManager.getTargetList2(condition);
    ...
    public ModelAndView checkDeviceType(
		...
		if( (mt.name()).equals(ModemType.SubGiga.name()) ){
			...
			if( (pt.name()).equals(Protocol.SMS.name()) || (pt.name()).equals(Protocol.GPRS.name()))
				type = "MBB";
			else
				type = "Ethernet";
		}
