...
/*    // 제조사 목록
    ...
    @RequestMapping(value = "/gadget/device/getMeterFromSerial")
	public ModelAndView getMeterFromSerial(@RequestParam("mdsId") String mdsId) {
		ModelAndView mav = new ModelAndView("jsonView");
...
//			msgMap.put("address",          fmtMessage[20]); // address를 customerAddr로 변경
    ...
    @RequestMapping(value = "/gadget/device/getAsyncLogListForMeterPrepm")
	public ModelAndView getAsyncLogListForMeter2(
			@RequestParam(value = "meterId", required = false) String meterId,
			@RequestParam(value = "startDate", required = false) String startDate,
			@RequestParam(value = "endDate", required = false) String endDate,
			@RequestParam(value = "loginId", required = false) String loginId
